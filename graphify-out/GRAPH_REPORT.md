...
## Corpus Check
- 162 files · ~59,122 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1219 nodes · 1880 edges · 104 communities (91 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5144652`
...
Cohesion: 0.06
Nodes (21): AgentRepo, EscalationRepo, EscalationRow, migrate(), PostgresStore, verdict_text(), build_from_config_validates_referenced_providers(), JudgeKind (+13 more)
...
Cohesion: 0.13
Nodes (10): Channel, CheckRequest, ClientOptions, Decode, RateLimited, SdkError, Transport, DEFAULT_RETRY (+2 more)
...
## Knowledge Gaps
- **311 isolated node(s):** `cfg`, `c`, `d`, `STATUS_TO_CODE`, `DEFAULT_RETRIABLE` (+306 more)
...
- **Why does `main()` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 20`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 6` to `Community 0`, `Community 2`, `Community 20`, `Community 13`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `build_app_state()` connect `Community 20` to `Community 0`, `Community 28`, `Community 13`?**
