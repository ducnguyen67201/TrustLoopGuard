...
## Corpus Check
- 211 files · ~81,210 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1743 nodes · 2837 edges · 121 communities (110 shown, 11 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 252 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7edfc71`
...
3. `SdkError` - 22 edges
4. `main()` - 21 edges
5. `AsyncClient` - 20 edges
6. `Technical terms` - 19 edges
7. `Client` - 17 edges
8. `Crates` - 17 edges
9. `PolicyRepo` - 15 edges
10. `load_agent_str()` - 15 edges
...
Cohesion: 0.08
Nodes (52): api_error_response(), ApiDoc, AppState, check(), router(), MemoryStore, PolicyValidationIssue, memory_app_state() (+44 more)
...
Cohesion: 0.08
Nodes (35): EscalationRepo, EscalationRow, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit, mock_embedder_round_trip_through_index() (+27 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (27): allow_helper_sets_verdict(), ApiError, ApiErrorCode, buffer_truncates_to_window(), Channel, CheckRequest, Client, Decision (+19 more)
...
Cohesion: 0.11
Nodes (27): api_error_response(), api_error_response_with_details(), delete_policy(), get_policy(), is_yaml_content_type(), list_policies(), load_str_and_validate_endpoint_agree_on_valid_yaml(), malformed_yaml_returns_validation_issue() (+19 more)
...
Cohesion: 0.13
Nodes (19): cn(), Alert(), AlertDescription(), AlertTitle(), alertVariants, DialogContent, DialogDescription, DialogFooter() (+11 more)
...
Cohesion: 0.16
Nodes (22): BaseModel, Enum, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, Channel (+14 more)
...
Cohesion: 0.26
Nodes (7): Home(), AppShell(), getServerUrl(), Playground(), PoliciesPage(), PolicyManager(), env
...
Cohesion: 0.33
Nodes (4): PolicyDocument, PolicyListResponse, PolicySummary, Severity
...
## Knowledge Gaps
- **465 isolated node(s):** `fetchSpy`, `client`, `cfg`, `c`, `d` (+460 more)
...
- **Why does `main()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 10`, `Community 18`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 3` to `Community 0`, `Community 2`, `Community 8`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `repo_root()` connect `Community 3` to `Community 1`?**
