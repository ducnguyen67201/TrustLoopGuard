...
## Corpus Check
- 203 files · ~78,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1666 nodes · 2606 edges · 121 communities (107 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 246 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1ba7ab4`
...
Cohesion: 0.05
Nodes (34): AgentRepo, api_error_response(), api_error_response_with_details(), delete_policy(), get_policy(), is_yaml_content_type(), list_policies(), load_str_and_validate_endpoint_agree_on_valid_yaml() (+26 more)
...
Cohesion: 0.08
Nodes (34): EscalationRepo, EscalationRow, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit, mock_embedder_round_trip_through_index() (+26 more)
...
Cohesion: 0.15
Nodes (26): Exception, ApiError, ApiErrorCode, Decode, Forbidden, Gone, Internal, Invalid (+18 more)
...
Cohesion: 0.09
Nodes (14): PolicyValidationResult, BuilderKey, BuilderValues, buildYaml(), INITIAL_BUILDER, LoadState, yamlString(), Button (+6 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (18): cn(), SeverityBadge(), Badge(), BadgeProps, badgeVariants, DialogContent, DialogDescription, DialogFooter() (+10 more)
...
## Knowledge Gaps
- **466 isolated node(s):** `fetchSpy`, `client`, `cfg`, `c`, `d` (+461 more)
...
- **Why does `load_str()` connect `Community 3` to `Community 0`, `Community 1`, `Community 18`, `Community 24`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 24` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 18`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `build_app_state()` connect `Community 18` to `Community 24`, `Community 1`, `Community 0`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Are the 14 inferred relationships involving `load_str()` (e.g. with `load_str_and_validate_endpoint_agree_on_valid_yaml()` and `load_policies()`) actually correct?**
  _`load_str()` has 14 INFERRED edges - model-reasoned connections that need verification._
