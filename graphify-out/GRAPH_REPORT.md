...
## Corpus Check
- 199 files · ~76,093 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1619 nodes · 2505 edges · 129 communities (113 shown, 16 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 246 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `89d0d96b`
...
Cohesion: 0.11
Nodes (44): router(), memory_app_state(), build_app(), build_app_with_store(), delete_then_get_returns_404(), delete_unknown_yields_404(), json_with_empty_agent_id_yields_422(), list_returns_all_agents() (+36 more)
...
Cohesion: 0.18
Nodes (9): cn(), Input, Label, labelVariants, ScrollArea, ScrollBar, Separator, Skeleton() (+1 more)
...
Cohesion: 0.4
Nodes (4): api_error_response(), ApiDoc, AppState, check()
...
- **Why does `main()` connect `Community 20` to `Community 0`, `Community 1`, `Community 3`, `Community 8`, `Community 17`, `Community 26`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 1` to `Community 0`, `Community 7`, `Community 17`, `Community 20`, `Community 26`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `repo_root()` connect `Community 20` to `Community 3`?**
