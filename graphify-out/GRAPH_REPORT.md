# Graph Report - TrustLoopGuard  (2026-07-16)

## Corpus Check
- 1517 files · ~798,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15714 nodes · 33113 edges · 1864 communities (1217 shown, 647 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1732 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc0f37f3`
...
2. `cn()` - 184 edges
3. `Client` - 152 edges
4. `AsyncClient` - 127 edges
5. `proxyRustJson()` - 98 edges
6. `AppState` - 93 edges
7. `Client` - 88 edges
8. `Domain terms` - 83 edges
9. `Policy` - 78 edges
...
## Communities (1864 total, 647 thin omitted)
...
### Community 3 - "cn"
Cohesion: 0.02
Nodes (157): AgentFilter(), AgentFilterProps, AppSidebar(), AppSidebarProps, data, getVisibleNavGroups(), workspace, AppLayoutProps (+149 more)

### Community 6 - "Client"
Cohesion: 0.10
Nodes (77): AuthorizationResult, Result type for guarded execution through the unified authorization kernel., AsyncClient, AsyncFinancialOperation, _AsyncRunContext, _AsyncRunEventContext, Client, FinancialOperation (+69 more)
...
Cohesion: 0.04
Nodes (38): Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger(), AuthorizationApprovalsContent(), buildSummary(), decisionResponseSchema (+30 more)
...
Cohesion: 0.07
Nodes (46): POST(), requestSchema, withOwnerAgent(), ACTION_LABEL, actionVariant(), EffectVariant, joinList(), MATCH_TYPE_LABEL (+38 more)
...
Cohesion: 0.04
Nodes (68): POST(), POST(), RouteContext, GET(), RouteContext, GET(), POST(), RouteContext (+60 more)
...
### Community 28 - "Client"
Cohesion: 0.07
Nodes (14): abortableDelay(), Client, cloneEvent(), deepFreeze(), newUuid(), RunContextStore, stringifyJson(), AgenticPaymentRecord (+6 more)

### Community 29 - "BudgetAlertConfig.ts"
Cohesion: 0.36
Nodes (6): RFC-3339, BudgetAlertThresholdType, BudgetAlertWindow, CreateBudgetAlertConfigRequest, SpendMeter, UpdateBudgetAlertConfigRequest
...
Cohesion: 0.05
Nodes (66): Badge(), badgeVariants, AuthorizationReceiptContent(), ACTION_STATE_VARIANT, AUTHORIZATION_VARIANT, BadgeVariant, counterpartyLabel(), currentContextQuery() (+58 more)
...
Cohesion: 0.04
Nodes (56): Page(), AuthorizationEffect, AuthorizationEffectLegend(), AuthorizationEffectLegendProps, BADGE_VARIANT, EFFECTS, BadgeVariant, countEffects() (+48 more)

### Community 69 - "UserContext"
Cohesion: 0.14
Nodes (47): InternalServiceContext, api_error(), approve_job(), callback(), cancel_job(), create_connection(), create_job(), disconnect_connection() (+39 more)
...
Cohesion: 0.07
Nodes (26): EmptyState(), EmptyStateProps, ApprovalCheckerModeControl(), InviteMemberDialog(), KnowledgeSourceCreateDialog(), AgentsPageContent(), AnalyticsPageContent(), DEFAULT_ACTION_LABELS (+18 more)

### Community 72 - "tlClientForRequest"
Cohesion: 0.08
Nodes (27): POST(), RouteContext, GET(), RouteContext, POST(), RouteContext, POST(), requestSchema (+19 more)

### Community 73 - "evaluate_tool_policies"
Cohesion: 0.12
...
Cohesion: 0.04
Nodes (82): BudgetDecisionCard(), buildGuardFlow(), buildRows(), DeliveryInterventionDetail(), DetailItem(), displayPolicy(), displayReason(), displayUserPrompt() (+74 more)
...
### Community 93 - "ui.ts"
Cohesion: 0.04
Nodes (99): createProviderPaymentsHandler(), POST, ProviderPaymentsDependencies, providerRequestSchema, safeErrorForLog(), validRequest, createClient(), isValidRefundDemoAuthorization() (+91 more)
...
Cohesion: 0.02
Nodes (112): AttackButton(), AttackFlow(), AttackFlowProps, AttacksPanel(), AttackTranscript(), buildDocumentTemplate(), bytesToBase64(), ConsoleState (+104 more)
...
### Community 100 - "MemorySettingsStore"
Cohesion: 0.16
...
### Community 106 - "path"
Cohesion: 0.15
Nodes (21): generate_404_maps_to_not_found(), generate_422_maps_to_unprocessable(), generate_503_maps_to_unavailable_and_is_retriable(), generate_response_body(), generate_returns_typed_response(), generate_url_encodes_agent_id(), list_for_unknown_agent_returns_empty(), list_response_body() (+13 more)
...
Cohesion: 0.03
Nodes (88): compareLabel(), formatDate(), ReportShareCard(), JOB, mockState, SHARE, TTL_OPTIONS, relativeTime() (+80 more)
...
Cohesion: 0.06
Nodes (41): buildRefundRequest(), createRefundGrant(), FinancialDemoClient, GRANT_REQUIREMENTS, REFUND_SCENARIOS, RefundScenario, runRefundDemo(), ScenarioKey (+33 more)
...
Cohesion: 0.05
Nodes (42): GuardToolCallOptions, Action, AllowedSource, ApprovalRule, AuthorizationSubject, CheckerFindingEvidence, CheckerRun, Confidentiality (+34 more)
...
Cohesion: 0.12
Nodes (21): AnalyticsStore, Send, Sync, Send, Sync, UserStore, BudgetAlertStore, Send (+13 more)

### Community 164 - "server.ts"
Cohesion: 0.10
Nodes (22): ListTracesInput, agentInput(), agentSchema, allowedSourceInput(), approval, approvalInput(), guardEvent, jsonObject (+14 more)
...
Cohesion: 0.12
Nodes (21): canonical(), schemaHash(), configSchema, loadConfig(), ProxyConfig, main(), AuthorizationGuard, blocked() (+13 more)
...
### Community 191 - "env.ts"
Cohesion: 0.09
Nodes (18): PostHogIdentity(), AppEnv, appEnvSchema, appUrls, CanonicalAppEnv, checkEnv(), docsUrls, getAppUrl() (+10 more)
...
### Community 220 - "HumanReviewEvent.ts"
Cohesion: 0.31
...
Cohesion: 0.11
Nodes (23): FailingClient, Duration, Result, JsonSchema, LlmError, LlmOutput, Duration, String (+15 more)
...
Cohesion: 0.06
Nodes (46): enforceModes(), headers(), main(), tools, ADMIN_USER_ID, AGENT_DEMO_WORLD_PORT, cleanOptionalEnv(), demoRoot() (+38 more)
...
### Community 319 - "guard"
Cohesion: 0.04
Nodes (108): GuardModeInput, OnAllowAsync, OnAllowSync, OnBlockAsync, OnBlockSync, OnDeferAsync, OnDeferSync, OnErrorAsync (+100 more)
...
Cohesion: 0.22
Nodes (16): FinancialExecutionError, FinancialExecutionResult, provider_body(), recovery_status(), reversal_capability(), FinancialActionRecord, Option, Result (+8 more)
...
### Community 347 - "PostgresBudgetAlertAdapter"
Cohesion: 0.18
...
Cohesion: 0.02
Nodes (81): apiKeyBatchRevokeResponseSchema, apiKeySchema, revokeApiKeys(), ClientOptions, CODE_TO_CLASS, codeFromHttpStatus(), Decode, DEFAULT_RETRIABLE (+73 more)
...
### Community 382 - "ToolMetadataStoreError"
Cohesion: 0.22
...
### Community 393 - "MemoryToolMetadataStore"
Cohesion: 0.18
...
### Community 395 - "MemoryAgentStore"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (35): POST(), RouteContext, GET(), GET(), DELETE(), PATCH(), GET(), POST() (+27 more)

### Community 423 - "fresh_repo"
Cohesion: 0.30
...
### Community 433 - "AnthropicGatewayProvider"
Cohesion: 0.28
...
Cohesion: 0.04
Nodes (61): ActiveRun, ActiveRunContext, AuthorizedShellActionOptions, browserRunContext(), buildFinancialOperationRequest(), cleanFinancialOperationField(), FinancialOperationRunOptions, ListTracesOptions (+53 more)
...
### Community 469 - "provider_json_response"
Cohesion: 0.32
...
Cohesion: 0.19
Nodes (15): GatewayState, proxy_anthropic_messages(), proxy_openai_chat_completions(), Bytes, Extension, HeaderMap, Option, Path (+7 more)
...
Cohesion: 0.25
Nodes (8): Approval and execution, Bounds and incomplete analysis, Claude Code bridge, Clean-room boundary, Request and ownership, Shell command safety, Shell facts, Tool policy contract

### Community 481 - "server.test.ts"
Cohesion: 0.38
...
### Community 509 - "CheckerFindingEvidence"
Cohesion: 0.33
Nodes (6): description, required, type, CheckerFindingEvidence, reason, rule

### Community 510 - "AuthorizationDecision.ts"
Cohesion: 0.05
Nodes (35): ActionGrantScope, ApprovalDecision, ApprovalEnvelope, ApprovalStatus, AuthorityRequirement, AuthorizationApproval, AuthorizationApprovalListResponse, AuthorizationApprovalSummary (+27 more)
...
### Community 525 - "AuthorizationResult"
Cohesion: 0.40
...
Cohesion: 0.07
Nodes (54): FinancialExecutor, Send, Sync, FinancialStore, Send, Sync, agentic_payment_principal(), authorization_error() (+46 more)
...
### Community 575 - "delete_tool_metadata"
Cohesion: 0.24
Nodes (18): delete_tool_metadata(), get_tool_metadata(), list_tool_metadata(), Arc, Extension, HeaderMap, Json, Option (+10 more)
...
Cohesion: 0.11
Nodes (29): EnvironmentStore, Send, Sync, draft_policy(), Bytes, Response, parse_policy_set(), policy_draft_item_schema() (+21 more)
...
### Community 1774 - "guard.ts"
Cohesion: 0.04
Nodes (66): guardedPayout(), headers(), main(), registerTool(), executePayment(), PaymentRequest, PaymentResult, simulatedLedger (+58 more)
...
### Community 1837 - "PaymentHttpFinancialExecutor"
Cohesion: 0.60
Nodes (4): PaymentHttpFinancialExecutor, Arc, Client, Self
...
Cohesion: 0.14
Nodes (14): definitions, KnowledgeSource, KnowledgeSourceKind, WorkflowRequirement, local, web, required, type (+6 more)
...
### Community 1880 - "button.tsx"
Cohesion: 0.03
Nodes (90): event(), ChangePasswordCardProps, AuthScreen(), AuthScreenProps, BrandRailProps, EFFECTS, FormError(), FormErrorProps (+82 more)
...
## Knowledge Gaps
- **2795 isolated node(s):** `printWidth`, `tabWidth`, `useTabs`, `semi`, `singleQuote` (+2790 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **647 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `StorageError` connect `StorageError` to `RunRepo`, `BudgetAlertRepo`, `github_integration_repo.rs`, `Result`, `Result`, `PostgresRedteamJobAdapter`, `EnvironmentRepo`, `tests.rs`, `MemoryRedteamPlanStore`, `ToolMetadataRepo`, `view_from_record`, `DashboardAdminStoreError`, `api_keys.rs`, `Result`, `team_repo.rs`, `GatewayStoreError`, `PostgresHumanReviewAdapter`, `llm_pricing.rs`, `RedteamPlanRepo`, `FinancialStoreError`, `.create_event`, `validation.rs`, `latest_review_outcomes`, `AuthorizationStoreError`, `LlmUsageStoreError`, `llm_usage_repo.rs`, `PostgresGitHubIntegrationAdapter`, `LlmPricingRepo`, `PostgresLabelPolicyAdapter`, `provider_record_to_wire`, `EnvironmentStoreError`, `PostgresUserAdapter`, `PolicyRepo`, `RunStoreError`, `Validation`, `AgentStoreError`, `models.rs`, `.analytics`, `AgentRepo`, `lib.rs`, `latest_review_outcomes`, `PostgresBudgetAlertAdapter`, `schema.rs`, `share.rs`, `metrics.rs`, `EscalationRepo`, `HumanReviewAnalyticsFilter`, `TeamStoreError`, `UserRepo`, `writer.rs`, `RedteamReportShareRepo`, `PostgresAnalyticsAdapter`, `KnowledgeRepo`, `dashboard_admin_repo.rs`, `ToolMetadataStoreError`?**
