...
## Corpus Check
- 192 files · ~72,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1529 nodes · 2293 edges · 119 communities (106 shown, 13 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57b04674`
...
Cohesion: 0.05
Nodes (41): EscalationRepo, EscalationRow, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit, mock_embedder_round_trip_through_index() (+33 more)
...
Cohesion: 0.09
Nodes (39): ApiDoc, AppState, check(), router(), MemoryStore, memory_app_state(), build_app(), build_app_with_store() (+31 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (42): absent_domain_defaults_to_customer_support(), agent_scope_matches(), channel_scope_matches(), domain_scope_matches(), matcher_hits(), matches_canonical_scope_fields(), policy_matches(), policy_scope_matches() (+34 more)
...
Cohesion: 0.09
Nodes (30): Exception, ApiError, Decode, Forbidden, Gone, Internal, Invalid, NotFound (+22 more)
...
Cohesion: 0.19
Nodes (12): AgentRepo, capacity_zero_disables_cache(), delete_is_idempotent_on_missing(), delete_makes_subsequent_get_not_found(), fresh_repo(), list_returns_only_active_agents(), missing_agent_returns_not_found(), sample_profile() (+4 more)

### Community 25 - "Community 25"
Cohesion: 0.1
Nodes (19): Adding a new crate, code:block1 (tl-cli      tl-server      tl-sdk-rust), code:yaml (id: refund-promise), code:bash (cargo run -p tl-codegen           # write), Crates, Dependency graph, `tl-cache` — decision cache, `tl-cli` — operator command line (+11 more)

### Community 26 - "Community 26"
Cohesion: 0.19
Nodes (18): BaseModel, Enum, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, ApiErrorCode (+10 more)
...
## Knowledge Gaps
- **448 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+443 more)
...
- **Why does `main()` connect `Community 19` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 3` to `Community 0`, `Community 4`, `Community 9`, `Community 16`, `Community 19`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `write_canonical()` connect `Community 21` to `Community 2`?**
