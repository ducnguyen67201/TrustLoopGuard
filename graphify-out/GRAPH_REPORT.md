...
## Corpus Check
- 204 files · ~79,291 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1690 nodes · 2650 edges · 122 communities (108 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7811195c`
...
8. `Crates` - 17 edges
9. `run()` - 15 edges
10. `v0 Design Decisions` - 15 edges
...
Cohesion: 0.05
Nodes (29): AgentRepo, EscalationRepo, EscalationRow, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit (+21 more)
...
Cohesion: 0.08
Nodes (50): api_error_response(), ApiDoc, AppState, check(), router(), MemoryStore, PolicyValidationIssue, memory_app_state() (+42 more)
...
Cohesion: 0.08
Nodes (29): allow_helper_sets_verdict(), ApiError, Channel, CheckRequest, Decision, new_trace_id(), Severity, TlError (+21 more)
...
Cohesion: 0.11
Nodes (27): load_agent_str(), loads_committed_fixture_acme_support_v3(), parses_full_featured_profile(), parses_minimal_profile(), rejects_malformed_yaml(), rejects_missing_agent_id(), rejects_missing_in_scope(), validate() (+19 more)
...
Cohesion: 0.14
Nodes (28): Exception, ApiError, ApiErrorCode, Decode, Forbidden, Gone, Internal, Invalid (+20 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (21): cn(), SeverityBadge(), Badge(), BadgeProps, badgeVariants, Button, ButtonProps, buttonVariants (+13 more)
...
Cohesion: 0.11
Nodes (10): BuilderKey, BuilderValues, buildYaml(), INITIAL_BUILDER, LoadState, yamlString(), Input, Label (+2 more)
...
Cohesion: 0.24
Nodes (6): AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, KnowledgeSource
...
Cohesion: 0.43
Nodes (4): getServerUrl(), PoliciesPage(), PolicyManager(), env
...
## Knowledge Gaps
- **470 isolated node(s):** `fetchSpy`, `client`, `cfg`, `c`, `d` (+465 more)
...
- **Why does `load_str()` connect `Community 1` to `Community 0`, `Community 2`, `Community 6`, `Community 9`, `Community 20`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 20`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `build_app_state()` connect `Community 20` to `Community 0`, `Community 9`, `Community 2`?**
