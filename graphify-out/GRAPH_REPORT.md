...
## Corpus Check
- 211 files · ~80,906 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1740 nodes · 2829 edges · 121 communities (110 shown, 11 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 252 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afc4b16d`
...
Cohesion: 0.05
Nodes (35): load_agent_str(), loads_committed_fixture_acme_support_v3(), parses_full_featured_profile(), parses_minimal_profile(), parses_web_knowledge_source_metadata(), rejects_duplicate_knowledge_source_ids(), rejects_malformed_yaml(), rejects_missing_agent_id() (+27 more)
...
Cohesion: 0.1
Nodes (13): BuilderKey, BuilderValues, buildYaml(), INITIAL_BUILDER, LoadState, SeverityBadge(), yamlString(), Input (+5 more)
...
## Knowledge Gaps
- **469 isolated node(s):** `fetchSpy`, `client`, `cfg`, `c`, `d` (+464 more)
...
- **Why does `main()` connect `Community 22` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 9`, `Community 18`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 3` to `Community 0`, `Community 2`, `Community 8`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `repo_root()` connect `Community 22` to `Community 1`?**
