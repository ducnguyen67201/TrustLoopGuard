...
## Corpus Check
- 191 files · ~71,866 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1525 nodes · 2288 edges · 126 communities (109 shown, 17 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c662d31c`
...
Cohesion: 0.05
Nodes (53): absent_domain_defaults_to_customer_support(), agent_scope_matches(), channel_scope_matches(), domain_scope_matches(), matcher_hits(), matches_canonical_scope_fields(), policy_matches(), policy_scope_matches() (+45 more)
...
Cohesion: 0.11
Nodes (29): Exception, ApiError, ApiErrorCode, Decode, Forbidden, Gone, Internal, Invalid (+21 more)
...
Cohesion: 0.09
Nodes (21): Args, build_request(), buildRequest(), Cli, Cmd, main(), print_decision(), printDecision() (+13 more)
...
Cohesion: 0.12
Nodes (6): EscalationRepo, EscalationRow, migrate(), PostgresStore, verdict_text(), run_judges()
...
Cohesion: 0.2
Nodes (17): BaseModel, Enum, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, Channel (+9 more)
...
Cohesion: 0.21
Nodes (8): cn(), Input, Separator, Skeleton(), TabsContent, TabsList, TabsTrigger, TooltipContent
...
Cohesion: 0.42
Nodes (8): load_agent_str(), loads_committed_fixture_acme_support_v3(), parses_full_featured_profile(), parses_minimal_profile(), rejects_malformed_yaml(), rejects_missing_agent_id(), rejects_missing_in_scope(), validate()
...
Cohesion: 0.64
Nodes (7): spawn_writer(), batch_size_triggers_flush(), caller_send_is_non_blocking_under_load(), fake_decision(), fresh_pool(), graceful_shutdown_flushes_remaining(), interval_flushes_partial_batch()
...
## Knowledge Gaps
- **447 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+442 more)
...
- **Why does `main()` connect `Community 8` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 22`, `Community 59`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 0` to `Community 8`, `Community 3`, `Community 22`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `build_app_state()` connect `Community 8` to `Community 32`, `Community 22`?**
