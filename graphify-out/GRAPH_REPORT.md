...
## Corpus Check
- 1270 files · ~620,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13528 nodes · 27456 edges · 1792 communities (1147 shown, 645 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 1605 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a77da058`
...
- 2-file cycle: `crates/tl-server/src/policies.rs -> crates/tl-server/src/policies/response.rs -> crates/tl-server/src/policies.rs`
...
## Communities (1792 total, 645 thin omitted)
...
### Community 3 - "cn"
Cohesion: 0.02
Nodes (150): AgentFilter(), AgentFilterProps, AppSidebar(), AppSidebarProps, data, NavGroup, NavItem, NavMain() (+142 more)

### Community 6 - "AsyncClient"
Cohesion: 0.09
Nodes (63): FactsT, InputT, AsyncClient, AsyncFinancialOperation, _AsyncRunContext, _AsyncRunEventContext, _build_financial_operation_request(), _clean_financial_operation_field() (+55 more)
...
Cohesion: 0.03
Nodes (110): ChangePasswordCardProps, AuthScreenProps, BrandRailProps, VERDICTS, SetupBrandHeader(), WelcomeBrandHeader(), WelcomeBrandHeaderProps, BrandLogo() (+102 more)
...
Cohesion: 0.03
Nodes (95): compareLabel(), formatDate(), ReportShareCard(), TTL_OPTIONS, ACTION_LABEL, actionVariant(), AgentOption, describeError() (+87 more)
...
Cohesion: 0.06
Nodes (37): POST(), DELETE(), PATCH(), GET(), POST(), POST(), RouteContext, proxyMock (+29 more)
...
Cohesion: 0.13
Nodes (30): AgentStore, Send, Sync, agent_disambiguator(), core_path(), core_vector(), delete_plan(), generate_static_policies() (+22 more)
...
Cohesion: 0.03
Nodes (150): BaseModel, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, AllowedSource, AnalyticsCatalogDimension (+142 more)

### Community 27 - "postgres.rs"
Cohesion: 0.07
Nodes (32): DecisionStore, Send, Sync, connect(), migrate(), PostgresStore, repair_known_schema_drift(), DbConnection (+24 more)

### Community 28 - "Client"
Cohesion: 0.08
Nodes (8): Client, RunContextStore, stringifyJson(), FinancialMandate, GuardEvent, GuardrailGenerateResponse, PolicyDocument, TraceListResponse

### Community 29 - "index.ts"
Cohesion: 0.03
Nodes (53): CODE_TO_CLASS, codeFromHttpStatus(), Decode, DEFAULT_RETRIABLE, Forbidden, fromResponse(), Gone, Internal (+45 more)
...
### Community 42 - "PolicyBuilderEditor.tsx"
Cohesion: 0.11
Nodes (28): POST(), requestSchema, withOwnerAgent(), ACTION_LABEL, actionVariant(), joinList(), MATCH_TYPE_LABEL, matchSummary() (+20 more)
...
Cohesion: 0.07
Nodes (57): run_dispatch(), create_report_mints_share_for_complete_job(), create_report_rejects_incomplete_job(), create_report_rejects_self_comparison(), dispatch_message(), dispatch_rejects_invalid_target(), dispatch_req(), dispatch_returns_201_and_queues_job() (+49 more)
...
Cohesion: 0.04
Nodes (36): RunListResponse, CreateFinancialActionRequest, FinancialActionDecisionReceipt, FinancialActionListResponse, FinancialActionRecord, FinancialApprovalRequestListResponse, FinancialMandateListResponse, FinancialOutcomeListResponse (+28 more)
...
Cohesion: 0.03
Nodes (160): ChangePasswordCard(), AccountPage(), AgentsPage(), AnalyticsPage(), AnalyticsSearchParams, ApiKeysPage(), escapeHeaderValue(), GET() (+152 more)
...
### Community 75 - "PostgresPolicyAdapter"
Cohesion: 0.14
...
Cohesion: 0.16
Nodes (19): ActiveRun, ClientOptions, Channel, CreateRunEventRequest, addDefined(), branchFor(), clientOptions(), createOutputGuard() (+11 more)
...
Cohesion: 0.13
Nodes (26): AuthConfig, EnvError, require_bearer(), require_internal_bearer(), Arc, Debug, Formatter, Into (+18 more)
...
Cohesion: 0.05
Nodes (82): combine_all_trusted_is_trusted(), combine_any_untrusted_is_untrusted(), combine_confidentiality_takes_max_rank(), combine_integrity_takes_min_rank(), combine_labels(), combine_unknown_conf_outranks_public_only(), combine_unknown_without_untrusted_is_unknown(), confidentiality_rank() (+74 more)
...
Cohesion: 0.10
Nodes (36): buildRows(), RunDetailLiveView(), BASE_SNAPSHOT, defaultEventLabel(), eventSnapshot(), latestUserDisplayText(), objectSchema, parseRunDetailSnapshot() (+28 more)
...
Cohesion: 0.11
Nodes (27): FinancialStoreError, String, financial_policy_from_request(), financial_policy_record(), FinancialActionExecutionAttempt, FinancialAuthorizationService, json_string_array_contains(), ledger_idempotency_key() (+19 more)
...
Cohesion: 0.06
Nodes (53): Exception, CreateFinancialPolicyRequest, FinancialPolicyRecord, Async variant of ``Client.create_financial_policy``., Create or update a financial spending control., code_from_http_status(), Decode, Forbidden (+45 more)
...
Cohesion: 0.04
Nodes (60): AuthScreen(), FormError(), FormErrorProps, OrDivider(), Spinner(), SpinnerProps, CredentialsForm(), CredentialsFormProps (+52 more)

### Community 117 - "Decision"
Cohesion: 0.06
Nodes (28): DemoMetric, Metrics, percentile(), Decision, GuardLogEvent, GuardMode, RegenerateFeedback, ACTION (+20 more)
...
Cohesion: 0.11
Nodes (27): runRefundAgent(), shouldUseOpenAI(), formatMoney(), searchOrderTool(), AgentState, initialMessages(), nextAssistantMessage(), runOpenAiRefundAgent() (+19 more)

### Community 124 - "StorageError"
Cohesion: 0.12
Nodes (34): DashboardAdminRepo, environment_checker_modes_from_record(), EnvironmentCheckerModesRecord, EnvironmentCheckerModesWriteRecord, mode_to_db(), optional_mode_to_db(), parse_data_handling_mode(), parse_enforcement_mode() (+26 more)
...
### Community 131 - "FinancialActionDecisionReceipt.ts"
Cohesion: 0.10
Nodes (19): FinancialOperationSpec, ApprovalRequirement, CounterpartyRef, EvidenceRef, FinancialAction, FinancialActionDecision, FinancialActionKind, FinancialAuthorizationScopeProof (+11 more)
...
Cohesion: 0.08
Nodes (40): GET(), MyWorkspace, MyWorkspacesResponse, POST(), userFromSession(), POST(), requestSchema, POST() (+32 more)
...
Cohesion: 0.09
Nodes (26): buildRefundRequest(), createRefundMandate(), FinancialDemoClient, REFUND_SCENARIOS, RefundScenario, runRefundDemo(), runRefundScenario(), ScenarioKey (+18 more)
...
### Community 152 - "policies.ts"
Cohesion: 0.04
Nodes (54): coverageLabel(), draftPolicyFromSessions(), HardenJobCard(), HardenJobCardProps, messageOf(), newPolicyHref(), operationLabel(), rejectionSummary() (+46 more)
...
Cohesion: 0.14
Nodes (49): ApprovalRequirement, CounterpartyRef, CreateFinancialActionRequest, CreateFinancialMandateRequest, CreateFinancialPolicyRequest, EvidenceRef, FinancialAction, FinancialActionDecision (+41 more)
...
Cohesion: 0.12
Nodes (14): buildRefundActionRequest(), ensureRefundMandate(), executeRefundTool(), messageForStatus(), normalizeReason(), normalizeRequestId(), providerReferenceFromReceipt(), REFUND_MANDATE_SCOPE (+6 more)
...
Cohesion: 0.10
Nodes (25): DashboardAdminStoreError, NewApiKey, Arc, Option, String, Uuid, dashboard_admin_store_error(), PostgresDashboardAdminAdapter (+17 more)
...
Cohesion: 0.06
Nodes (24): ActionBadge(), CredentialBadge(), EnumSelect(), FAIL_MODES, FRIENDLY_LABELS, friendlyLabel(), GatewayPageContent(), GatewayPageData (+16 more)
...
Cohesion: 0.07
Nodes (52): resolve_environment_id(), HeaderMap, Response, Result, String, workspace_id_from_headers(), candidate_source(), ClassGroup (+44 more)
...
### Community 311 - "environment_deployments.rs"
Cohesion: 0.24
...
Cohesion: 0.17
Nodes (17): LabelPolicyUnavailable, label_policy_store_error(), origin_key(), PostgresLabelPolicyAdapter, Arc, Option, Origin, PolicyRepo (+9 more)

### Community 319 - "Enum"
Cohesion: 0.03
Nodes (112): Enum, GuardModeInput, OnAllowAsync, OnBlockAsync, OnErrorAsync, OnEscalateAsync, OnReviseAsync, Action (+104 more)
...
Cohesion: 0.15
Nodes (28): action_verdict(), compose(), evaluate_financial_policies(), financial_windowed_verdict(), per_action_verdicts(), Action, FinancialAction, I (+20 more)
...
Cohesion: 0.23
Nodes (27): app(), app_for(), create_payment_connection(), financial_action_decision_receipt_explains_held_refund(), financial_action_decision_receipt_missing_action_returns_404(), financial_action_outcomes_record_and_list(), financial_actions_create_get_and_transition(), financial_actions_list_workspace_actions() (+19 more)

### Community 340 - "handlers.rs"
Cohesion: 0.14
Nodes (22): create_review_event(), human_review_analytics(), list_review_events(), CreateHumanReviewEventRequest, HeaderMap, Json, Path, Response (+14 more)

### Community 341 - "build_postgres_layer"
Cohesion: 0.08
Nodes (28): AnalyticsStore, Send, Sync, ApiKeyStore, Send, Sync, SettingsStore, HumanReviewStore (+20 more)
...
### Community 344 - "app_state.rs"
Cohesion: 0.10
Nodes (29): FinancialExecutionError, FinancialExecutionResult, FinancialExecutor, PaymentHttpFinancialExecutor, provider_body(), recovery_status(), reversal_capability(), Arc (+21 more)

### Community 345 - "PostgresToolMetadataAdapter"
Cohesion: 0.21
...
Cohesion: 0.11
Nodes (26): guardedPayout(), headers(), main(), registerTool(), enforceModes(), headers(), main(), tools (+18 more)

### Community 363 - "Client"
Cohesion: 0.06
Nodes (41): AsyncBaseTransport, BaseTransport, Client, CreateFinancialMandateRequest, FinancialActionOutcome, FinancialMandate, RetryConfig, Synchronous TrustLoopGuard client.      Args:         base_url: TrustLoopGuard s (+33 more)
...
Cohesion: 0.05
Nodes (42): ActiveRunContext, browserRunContext(), buildFinancialOperationRequest(), cleanFinancialOperationField(), FinancialOperationRunOptions, ListTracesOptions, runContext(), WithRunOptions (+34 more)
...
Cohesion: 0.12
Nodes (21): AuthUserState, MemoryUserStore, HashMap, Result, RwLock, Self, String, UserRecord (+13 more)
...
Cohesion: 0.17
Nodes (23): customerBackendState(), ensureOrderDatabase(), findOrder(), listOrders(), listRefunds(), nullableTextValue(), numberValue(), openDatabase() (+15 more)
...
### Community 432 - "api_error_response"
Cohesion: 0.12
...
### Community 443 - "provider_json_response"
Cohesion: 0.30
...
### Community 460 - "Severity.ts"
Cohesion: 0.12
Nodes (15): TriggeredPolicy, Vec, Tier, TierResult, TierStatus, CreateFinancialPolicyRequest, FinancialActionPrecondition, FinancialDecisionRisk (+7 more)

### Community 461 - "FinancialActionOutcome.ts"
Cohesion: 0.33
Nodes (4): FinancialActionOutcome, FinancialActionOutcomeStatus, RecoveryStatus, ReversalCapability
...
Cohesion: 0.05
Nodes (57): ConnectAgentStep(), FirstEventStatus(), FLOW_BEATS, NEXT_STEPS, onboardingContextQuery(), CREATED, CopyBlock(), useFirstTrace() (+49 more)

### Community 476 - "fuzzy.rs"
Cohesion: 0.39
...
Cohesion: 0.14
Nodes (26): assert_human_review_schema_exists(), assert_human_review_schema_missing(), assert_legacy_orphan_trace_preserved(), assert_migration_was_recorded(), assert_relation_state(), drop_human_review_schema(), establish(), fresh_database_url() (+18 more)
...
Cohesion: 0.29
Nodes (5): apiKeyBatchRevokeResponseSchema, apiKeySchema, revokeApiKeys(), ApiKeyBatchRevokeRequest, ApiKeyBatchRevokeResponse
...
### Community 535 - "api_error_response"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (43): financial_matches(), action_decision(), authorization_scope_summary(), compose_policy_decisions(), decision_receipt_reason(), enforcing_action(), evidence_bool(), evidence_for_key() (+35 more)
...
## Knowledge Gaps
- **2781 isolated node(s):** `printWidth`, `tabWidth`, `useTabs`, `semi`, `singleQuote` (+2776 more)
...
- **Why does `State` connect `State` to `create_knowledge_source`, `oauth.rs`, `UserStoreError`, `workspace_id_from_headers`, `label_policy.rs`, `plan.rs`, `policies.ts`, `traces.rs`, `event_service.rs`, `authorize_workspace_admin`, `api_error_response`, `EnvironmentStore`, `generate_guardrails`, `PolicyState`, `handlers.rs`, `AuthConfig`, `change_password`, `RedteamState`, `GatewayState`, `WorkspaceKeyContext`, `agents.rs`, `RunState`, `TeamStore`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `StorageError` connect `StorageError` to `PostgresAnalyticsAdapter`, `Result`, `RedteamJobStoreError`, `EnvironmentRepo`, `Result`, `postgres.rs`, `RedteamPlanRepo`, `.create_event`, `PostgresUserAdapter`, `MemoryRedteamPlanStore`, `api_keys.rs`, `Result`, `event_summary`, `insert_existing_workspace_member`, `PostgresGatewayAdapter`, `analytics_query.rs`, `ToolMetadataRepo`, `latest_review_outcomes`, `PostgresFinancialAdapter`, `.create_event`, `validation.rs`, `environment_deployments.rs`, `Validation`, `gateway_repo.rs`, `PostgresLabelPolicyAdapter`, `profile_record_to_wire`, `EnvironmentStore`, `MemoryStore`, `UserRepo`, `PolicyRepo`, `RunStoreError`, `.update_view`, `models.rs`, `analytics.rs`, `AgentRepo`, `handlers.rs`, `PostgresToolMetadataAdapter`, `schema.rs`, `share.rs`, `metrics.rs`, `EscalationRepo`, `RedteamReportShareRepo`, `TeamStoreError`, `KnowledgeRepo`, `writer.rs`, `DashboardAdminStoreError`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `AppState` connect `AppState` to `oauth.rs`, `mod.rs`, `plan.rs`, `traces.rs`, `router`, `Engine`, `proxy_provider_request`, `HandlerCtx`, `MemoryRedteamPlanStore`, `runs.rs`, `event_service.rs`, `GatewayStore`, `JwtSigner`, `EnvironmentStore`, `mod.rs`, `gateway_routes`, `check_and_maybe_regenerate`, `financial_actions.rs`, `build_postgres_layer`, `AuthConfig`, `app_state.rs`, `mod.rs`, `GatewayState`, `effective_checker_modes`, `share.rs`, `event_ingestion.rs`, `TeamStore`, `escalation.rs`?**
