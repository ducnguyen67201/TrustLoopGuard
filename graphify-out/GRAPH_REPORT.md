...
## Corpus Check
- 158 files · ~56,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1178 nodes · 1795 edges · 95 communities (85 shown, 10 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03fd068e`
...
Cohesion: 0.05
Nodes (40): ApiError, ApiErrorCode, Channel, CheckRequest, Client, ClientOptions, CODE_TO_CLASS, codeFromHttpStatus() (+32 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (29): AuthConfig, EnvError, from_env_rejects_missing(), require_bearer(), subtle_eq(), unauthorized(), Client, parse_retry_after() (+21 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (33): AgentRepo, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit, mock_embedder_round_trip_through_index(), orthogonal_vector_below_threshold() (+25 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (25): FuzzyChecker, FuzzyHit, HandlerCtx, NoOpFuzzyChecker, NoOpProfileResolver, ProfileResolver, allow_output(), default_runner_with_no_policies_yields_allow() (+17 more)
...
Cohesion: 0.08
Nodes (21): bench_check_async_50_policies_4kb(), bench_check_async_empty_default(), bench_check_sync_empty(), bench_universal_only_4kb(), fifty_policies(), large_req(), small_req(), BuildError (+13 more)
...
Cohesion: 0.15
Nodes (22): Exception, ApiError, ApiErrorCode, Forbidden, Gone, Internal, Invalid, NotFound (+14 more)
...
Cohesion: 0.18
Nodes (9): AppState, build_app_state(), build_llm_router(), build_memory_layer(), build_postgres_layer(), BuildOptions, load_policies(), MemoryAgentStore (+1 more)
...
Cohesion: 0.22
Nodes (15): BaseModel, Enum, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, Channel (+7 more)
...
Cohesion: 0.18
Nodes (12): test_status_to_code_table_matches_rust(), code_from_http_status(), from_response(), parse_retry_after(), RateLimited, Typed errors for the TrustLoopGuard Python SDK.  Mirrors `tl-sdk-rust`'s `SdkErr, 429 — rate limited. Honor `retry_after` when set., Build a typed SdkError from a raw HTTP response.      Mirrors `SdkError::from_re (+4 more)
...
## Knowledge Gaps
- **309 isolated node(s):** `cfg`, `c`, `d`, `STATUS_TO_CODE`, `DEFAULT_RETRIABLE` (+304 more)
...
- **Why does `main()` connect `Community 13` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 19`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 5` to `Community 3`, `Community 1`, `Community 19`, `Community 13`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `run_judges()` connect `Community 9` to `Community 1`?**
