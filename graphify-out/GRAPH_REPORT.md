# Graph Report - TrustLoopGuard  (2026-08-03)

## Corpus Check
- 1728 files · ~1,083,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18147 nodes · 39101 edges · 1922 communities (1279 shown, 643 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1904 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7e598db3`
...
- `HealthcareDemoHandlersDependencies` --references--> `HostedHealthcarePolicyInventoryResponse`  [EXTRACTED]
...
## Communities (1922 total, 643 thin omitted)

### Community 1 - "agno.py"
Cohesion: 0.05
Nodes (118): AgnoAgentT, BaseEvent, BaseMiddleware, Context, ModelResponse, RunOutput, Action, AuthorizationEffect (+110 more)
...
### Community 3 - "cn"
Cohesion: 0.03
Nodes (109): AgentFilter(), AgentFilterProps, AppSidebar(), AppSidebarProps, data, getVisibleNavGroups(), workspace, NavGroup (+101 more)

### Community 6 - "Client"
Cohesion: 0.15
Nodes (72): AuthorizationResult, Result type for guarded execution through the unified authorization kernel., AsyncClient, AsyncFinancialOperation, _AsyncRunContext, _AsyncRunEventContext, Client, FinancialOperation (+64 more)

### Community 9 - "ManagementPages.tsx"
Cohesion: 0.04
Nodes (40): CardAction(), DataTableColumn, columns, Row, rows, EmptyState(), EmptyStateProps, ApprovalCheckerModeControl() (+32 more)
...
Cohesion: 0.03
Nodes (69): POST(), runtime, GET(), PUT(), RouteContext, runtime, POST(), RouteContext (+61 more)
...
Cohesion: 0.02
Nodes (121): AttackButton(), AttackFlow(), AttackFlowProps, AttacksPanel(), AttackTranscript(), buildDocumentTemplate(), bytesToBase64(), ConsoleState (+113 more)
...
### Community 29 - "api/_shared.ts"
Cohesion: 0.04
Nodes (58): POST(), RouteContext, runtime, GET(), RouteContext, runtime, POST(), RouteContext (+50 more)
...
### Community 43 - "postgres"
Cohesion: 0.07
Nodes (37): Duration, GatewayProviderConnectionSecret, GatewayRepo, GatewayRoutePatch, ResolvedGatewayRoute, DbConnection, DbPool, GatewayProviderConnection (+29 more)

### Community 44 - "dashboard-data.ts"
Cohesion: 0.03
Nodes (166): ChangePasswordCard(), AccountPage(), AgentsPage(), AnalyticsPage(), AnalyticsSearchParams, ApiKeysPage(), escapeHeaderValue(), GET() (+158 more)
...
Cohesion: 0.16
Nodes (17): create_knowledge_source(), get_knowledge_source_file(), list_knowledge_sources(), CreateKnowledgeSourceRequest, Extension, HeaderMap, Json, Option (+9 more)
...
Cohesion: 0.06
Nodes (48): AnalyticsChartGrid(), AnalyticsChartGridProps, AnalyticsWidget(), applyGridOrder(), DEFAULT_LAYOUT, DEFAULT_VIEW, DIMENSION_LABELS, dimensionLabel() (+40 more)
...
Cohesion: 0.04
Nodes (54): Page(), contextQueryFor(), loadFirings(), safeLoad(), UsagePage(), ChartConfig, ChartContainer(), ChartContext (+46 more)
...
Cohesion: 0.05
Nodes (34): RunListResponse, AgenticPaymentAuthorizationResponse, AgenticPaymentAuthorizeRequest, AuthorizationApproval, AuthorizationApprovalListResponse, AuthorizationGrantListResponse, AuthorizationReceipt, FinancialActionListResponse (+26 more)
...
Cohesion: 0.06
Nodes (33): FactsT, InputT, _build_financial_operation_request(), _clean_financial_operation_field(), AgenticPaymentCommitRequest, AgenticPaymentRecord, AgenticPaymentRollbackRequest, AuthorizationClaim (+25 more)
...
Cohesion: 0.08
Nodes (29): POST(), RouteContext, runtime, POST(), requestSchema, runtime, DraftingClient, DraftResponse (+21 more)
...
Cohesion: 0.08
Nodes (41): createProviderPaymentsHandler(), dynamic, POST, ProviderPaymentsDependencies, providerRequestSchema, runtime, safeErrorForLog(), validRequest (+33 more)
...
Cohesion: 0.06
Nodes (61): forwarded_user_id(), require_approved_user(), Option, Request, Response, Result, Uuid, AuthConfig (+53 more)

### Community 87 - "guard.ts"
Cohesion: 0.08
Nodes (36): LiveKitRunOptions, AutomaticRunController, AutomaticRunTerminalStatus, ClientOptions, WithRunOptions, AuthorizationSubject, Channel, CreateRunEventRequest (+28 more)
...
Cohesion: 0.12
Nodes (22): expire_approval(), expire_grant(), key(), MemoryAuthorizationIntent, MemoryAuthorizationStore, NewAuthorizationApproval, AuthorizationApproval, AuthorizationDomain (+14 more)
...
Cohesion: 0.09
Nodes (28): CompanyDemoPage(), CompanyDemoPageProps, dynamic, generateMetadata(), CompanyDemoViewModel, OutboundDemoProfile, CONTEXTUAL_PAGE_COPY, CONTEXTUAL_UI_COPY (+20 more)
...
### Community 106 - "path"
Cohesion: 0.10
Nodes (35): deadline_exceeded_yields_timeout(), malformed_inner_json_yields_parse_error(), non_2xx_yields_status_error(), ok_response(), openai_sends_bearer_auth_and_json_schema_body(), openrouter_adds_http_referer(), schema(), generate_404_maps_to_not_found() (+27 more)
...
Cohesion: 0.05
Nodes (65): Exception, RateLimited, code_from_http_status(), Forbidden, from_response(), Gone, Internal, Invalid (+57 more)

### Community 111 - "AnalyticsStoreError"
Cohesion: 0.12
Nodes (22): AnalyticsStoreError, MemoryAnalyticsStore, AnalyticsDashboardView, AnalyticsFacetCatalogResponse, AnalyticsQueryRequest, AnalyticsQueryResponse, CreateAnalyticsDashboardViewRequest, HashMap (+14 more)
...
Cohesion: 0.22
Nodes (24): ApiKeyBatchRevokeRequest, DashboardAdminState, batch_revoke_api_keys(), create_api_key(), generate_plaintext_key(), get_environment_checker_modes(), get_settings(), list_api_keys() (+16 more)
...
Cohesion: 0.08
Nodes (24): CodeBlock(), CodeBlockProps, highlight(), KEYWORDS, LABELS, Lang, tokenize(), ControlLoop() (+16 more)
...
Cohesion: 0.07
Nodes (54): ContextualDemoHandlersDependencies, approvalReply(), boundedHistoryItems(), boundedProfileContext(), buildContextualModelInput(), cap(), ContextualAgentClient, ContextualAgentDependencies (+46 more)

### Community 124 - "StorageError"
Cohesion: 0.09
Nodes (43): AnalyticsRepo, clear_default(), ensure_view_exists(), AnalyticsDashboardView, CreateAnalyticsDashboardViewRequest, DbConnection, Result, UpdateAnalyticsDashboardViewRequest (+35 more)
...
Cohesion: 0.09
Nodes (42): Badge(), badgeVariants, PageHeader(), PageHeaderProps, AuthorizationReceiptContent(), ACTION_STATE_VARIANT, AUTHORIZATION_VARIANT, BadgeVariant (+34 more)
...
Cohesion: 0.09
Nodes (31): POST(), requestSchema, runtime, withOwnerAgent(), ACTION_LABEL, actionVariant(), EffectVariant, joinList() (+23 more)
...
Cohesion: 0.07
Nodes (31): LegacyUseCasePageProps, Page(), AGENT_SPENDING_CAPS_USE_CASE, EMAIL_USE_CASE, getUseCase(), SHELL_COMMAND_USE_CASE, USE_CASE_MENU_CLOSE_DELAY_MS, USE_CASE_NAV_GROUPS (+23 more)
...
Cohesion: 0.04
Nodes (42): DemoMetric, Metrics, percentile(), abortableDelay(), AuthorizedActionResult, cloneEvent(), deepFreeze(), newUuid() (+34 more)
...
Cohesion: 0.05
Nodes (63): AgentStore, Send, Sync, AnalyticsStore, Send, Sync, Send, Sync (+55 more)
...
Cohesion: 0.05
Nodes (60): CheckRequest, CreateRunEventRequest, Default, RedactionInfo, absent_domain_defaults_to_customer_support(), agent_scope_matches(), channel_scope_matches(), domain_scope_matches() (+52 more)
...
### Community 168 - "healthcare-demo.tsx"
Cohesion: 0.05
Nodes (56): clientAddress(), createHealthcareDemoHandlers(), dynamic, GET, handlers, HealthcareDemoHandlersDependencies, isRateLimited(), POST (+48 more)
...
### Community 191 - "MemoryToolMetadataStore"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (28): crossed(), deliver_firing(), evaluate_spend_alerts(), firing_payload(), meter_from_str(), meter_label(), min_window_caps(), process_spend() (+20 more)
...
### Community 228 - "use-cases/page.tsx"
Cohesion: 0.07
Nodes (34): UseCaseData, metadata, COPY, Cta(), COPY, Footer(), getFooterEvent(), LINK_GROUPS (+26 more)
...
Cohesion: 0.11
Nodes (27): resolveProfile(), CONTEXTUAL_AGENT_PROFILE, CONTEXTUAL_DEMO_AGENT_DISPLAY_NAME, CONTEXTUAL_DEMO_WORKSPACE_NAME, CONTEXTUAL_DISABLED_STARTER_POLICY_IDS, CONTEXTUAL_POLICY_PACKS, CONTEXTUAL_SCENARIO_IDS, isContextualScenarioId() (+19 more)
...
### Community 239 - "errors.ts"
Cohesion: 0.07
Nodes (28): AutomaticRunWarning, CODE_TO_CLASS, codeFromHttpStatus(), Decode, DEFAULT_RETRIABLE, Forbidden, fromResponse(), Gone (+20 more)
...
### Community 249 - "test_agno.py"
Cohesion: 0.26
Nodes (17): _decision(), asyncio, mock, parametrize, _run_context(), test_agno_approval_timeout_returns_safe_result_without_execution(), test_agno_async_client_installs_coroutine_hooks_and_executes_once(), test_agno_customer_sdk_error_and_regular_error_are_preserved() (+9 more)
...
Cohesion: 0.06
Nodes (45): clientAddress(), dynamic, GET, handlers, isRateLimited(), POST, pruneExpiredHits(), RouteContext (+37 more)
...
Cohesion: 0.08
Nodes (25): dependencies, class-variance-authority, @dnd-kit/utilities, @featherlane-ai/sdk, lucide-react, @monaco-editor/react, next, posthog-js (+17 more)
...
### Community 280 - "EnvironmentStore"
Cohesion: 0.09
Nodes (31): EnvironmentStore, Send, Sync, Arc, RunState, ChannelTraceStore, effect_text(), list_traces() (+23 more)
...
Cohesion: 0.07
Nodes (36): WorkspaceApiKeyVerifyError, DashboardAdminStoreError, memory_api_key_to_wire(), MemoryApiKeyRecord, MemoryApiKeyStore, MemorySettingsStore, normalize_ids(), DashboardApiKey (+28 more)
...
### Community 300 - "[category]/route.test.ts"
Cohesion: 0.36
...
### Community 304 - "view_from_record"
Cohesion: 0.27
...
### Community 308 - "tool-runner.ts"
Cohesion: 0.08
Nodes (37): OPENAI_API_KEY, OPENAI_MODEL, runRefundAgent(), shouldUseOpenAI(), main(), promptFromArgsOrStdin(), ensureRefundGrant(), executeRefundTool() (+29 more)
...
Cohesion: 0.06
Nodes (47): agentProfile(), Appointment, AppointmentInput, appointments, bookAppointment, main(), rawAgent, traceEventKind() (+39 more)
...
### Community 318 - "outcomes/route.test.ts"
Cohesion: 0.28
Nodes (6): GET(), POST(), RouteContext, runtime, proxyMock, RouteContext

### Community 319 - "guard"
Cohesion: 0.07
Nodes (79): GuardModeInput, OnAllowAsync, OnAllowSync, OnBlockAsync, OnBlockSync, OnDeferAsync, OnDeferSync, OnErrorAsync (+71 more)
...
Cohesion: 0.02
Nodes (140): ACTION_LABEL, actionVariant(), AgentOption, describeError(), EffectVariant, FieldErrors, FieldProps, MATCH_TYPE_LABEL (+132 more)
...
### Community 328 - "harden-job-card.tsx"
Cohesion: 0.11
...
### Community 337 - "commands.test.ts"
Cohesion: 0.20
...
Cohesion: 0.02
Nodes (73): ApiKeyBatchRevokeRequest, ApiKeyListResponse, ComparedAttackStatus, CreateApiKeyRequest, CreateApiKeyResponse, CreateGatewayProviderConnectionRequest, CreateGatewayRouteRequest, CreateMcpGatewayConnectionRequest (+65 more)

### Community 361 - "router/tests.rs"
Cohesion: 0.23
Nodes (16): BlockingClient, concurrent_requests_cannot_claim_the_same_remaining_budget(), missing_route_yields_http_error(), MockClient, no_fallback_propagates_primary_error(), over_budget_blocks_request_before_calling_provider(), primary_failure_falls_back_to_secondary(), primary_success_records_budget_and_skips_fallback() (+8 more)
...
Cohesion: 0.39
Nodes (8): authority_template_substitutes_all_placeholders(), build(), build_batch(), hallucination_template_substitutes_all_placeholders(), String, semantic_policy_batch_template_substitutes_all_placeholders(), semantic_policy_template_substitutes_all_placeholders(), tone_template_substitutes_all_placeholders()
...
Cohesion: 0.05
Nodes (69): PROCUREMENT_AGENT, PROCUREMENT_RUNNER, ProcurementAgentDependencies, ProcurementAgentResult, ProcurementAuthorizationClient, ProcurementLiveAgentError, ProcurementRunContext, ProcurementRunLogger (+61 more)
...
Cohesion: 0.17
Nodes (24): build_app(), build_app_with_auth(), build_protected_app(), delete_agent_cascades_to_owned_policies(), generate_for_missing_agent_is_404(), generate_persists_each_draft_disabled_and_returns_them(), generate_without_system_prompt_is_422(), list_for_unknown_agent_returns_empty() (+16 more)
...
### Community 382 - "procurement-page.tsx"
Cohesion: 0.09
Nodes (17): COPY, DemoAppLink(), PROCUREMENT_DEMO_COPY, metadata, PersonalizedProcurementStyle, ProcurementDemoPageContent(), ProcurementDemoPageContentProps, COPY (+9 more)
...
Cohesion: 0.11
Nodes (28): FailingClient, Duration, Result, JsonSchema, LlmError, LlmOutput, Duration, String (+20 more)
...
### Community 432 - "PolicyEditorDialog.test.tsx"
Cohesion: 0.25
...
Cohesion: 0.17
Nodes (20): ProviderTarget, AuditedLlmError, AuditedLlmOutput, failed_audit(), JudgeKind, LlmCallAudit, LlmRouter, LlmRouterSession (+12 more)
...
### Community 450 - "GatewayPageContent.tsx"
Cohesion: 0.03
Nodes (84): ChangePasswordCardProps, AuthScreenProps, BrandRailProps, EFFECTS, dynamic, buildRetryUrl(), createWorkspace(), firstParam() (+76 more)
...
Cohesion: 0.06
Nodes (59): boundedHistoryItems(), buildHealthcareModelInput(), cap(), decisionCheck(), generateHealthcareDraft, GuardHealthcareDraft, GuardHealthcareDraftRequest, GuardHealthcareDraftResult (+51 more)
...
Cohesion: 0.04
Nodes (56): ConnectAgentStep(), FirstEventStatus(), FLOW_BEATS, NEXT_STEPS, onboardingContextQuery(), CREATED, CopyBlock(), EFFECT_VARIANTS (+48 more)
...
### Community 478 - "PostgresEnvironmentAdapter"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (20): ibmPlexMono, instrumentSans, metadata, RootLayoutProps, applyTheme(), disableTransitions(), getSystemTheme(), ResolvedTheme (+12 more)
...
Cohesion: 0.04
Nodes (68): CreateRunEventRequest, Result, RunEventSummary, Vec, RunRepo, latest_review_outcomes(), DateTime, DbConnection (+60 more)
...
### Community 515 - "financial/receipts/[id]/route.ts"
Cohesion: 0.33
...
### Community 522 - "ToolMetadataStoreError"
Cohesion: 0.22
...
### Community 525 - "BudgetAlertStoreError"
Cohesion: 0.20
...
Cohesion: 0.10
Nodes (41): assertProviderSuccess(), main(), providerRequest(), buildRefundActionRequest(), normalizeReason(), normalizeRequestId(), RefundAuthorizationOptions, refundOperation() (+33 more)
...
Cohesion: 0.18
Nodes (11): properties, required, type, items, type, ApprovalRule, type, required (+3 more)
...
### Community 543 - "null"
Cohesion: 0.19
Nodes (14): properties, integer, null, string, type, type, type, $ref (+6 more)
...
Cohesion: 0.08
Nodes (53): FinancialStoreError, agentic_payment_counterparty(), agentic_payment_metadata(), agentic_payment_principal(), authorization_error(), decision_from_action(), enforcing_effect(), ensure_agentic_payment_principal() (+45 more)
...
### Community 580 - "tests/redteam_plan.rs"
Cohesion: 0.34
...
### Community 591 - "workspaces/[id]/route.ts"
Cohesion: 0.15
...
### Community 665 - "Any"
Cohesion: 0.12
Nodes (17): AuthorizationResult, _merge_context(), Any, AuthorizationDecision, EventKind, GuardEvent, Principal, ProvenanceMap (+9 more)

### Community 669 - "required"
Cohesion: 0.18
...
### Community 673 - "entrypoint"
Cohesion: 0.24
Nodes (9): entrypoint(), gateway_api_key(), gateway_openai_base_url(), HealthcareProxyAgent, livekit_run_external_id(), Agent, JobContext, rtc_session (+1 more)
...
Cohesion: 0.08
Nodes (33): FuzzyChecker, FuzzyHit, HandlerCtx, NoOpFuzzyChecker, NoOpProfileResolver, ProfileResolver, AgentProfile, Arc (+25 more)
...
### Community 899 - "LabelPolicyProvider"
Cohesion: 0.17
Nodes (12): LabelPolicyProvider, LabelPolicyUnavailable, NoOpLabelPolicyProvider, PolicyLabelResolver, ProvenancePropagator, Arc, GuardEvent, Result (+4 more)
...
### Community 1730 - "credentials-form.tsx"
Cohesion: 0.13
Nodes (23): AuthScreen(), FormError(), FormErrorProps, OrDivider(), Spinner(), SpinnerProps, CredentialsForm(), CredentialsFormProps (+15 more)

### Community 1731 - "PipelineFixture"
Cohesion: 0.25
Nodes (9): FailingLabelPolicyProvider, PipelineFixture, Arc, Option, Result, Self, SourceLabelPolicy, Vec (+1 more)

### Community 1732 - "PolicyStore"
Cohesion: 0.20
Nodes (11): BudgetAlertRuntime, Sender, SpendAlertEvaluation, FinancialStore, Send, Sync, Arc, Self (+3 more)
...
### Community 1734 - "store/memory.rs"
Cohesion: 0.19
...
### Community 1735 - "[...nextauth]/route.ts"
Cohesion: 0.73
...
Cohesion: 0.11
Nodes (31): build_policy_draft_llm(), router(), Arc, Option, memory_app_state(), analytics_catalog_query_and_saved_views_round_trip(), analytics_endpoints_are_protected_by_bearer_auth(), internal_bearer_analytics_authorizes_members_and_platform_admins() (+23 more)
...
### Community 1854 - "proxy_anthropic_messages"
Cohesion: 0.38
...
Cohesion: 0.04
Nodes (67): MonacoDiffEditor, PolicyYamlDiffEditor(), Props, relativeTime(), VersionEntry, AuthorizationEffect, AuthorizationEffectLegend(), AuthorizationEffectLegendProps (+59 more)
...
### Community 1887 - "KnowledgeSourceDocument.ts"
Cohesion: 0.22
...
### Community 1917 - "RecordingTraceStore"
Cohesion: 0.31
Nodes (7): RecordingTraceStore, Mutex, Option, Result, String, TraceSummary, Vec

### Community 1925 - "$defs"
Cohesion: 0.14
Nodes (14): required, type, $defs, AllowedSource, Origin, ParamRole, SideEffectClass, authority_bearing (+6 more)
...
### Community 1931 - "CheckerFindingEvidence"
Cohesion: 0.33
...
### Community 1939 - "github_integration/mod.rs"
Cohesion: 0.17
Nodes (22): GitHubClient, Send, Sync, axum::Json<T>, GitHubIntegrationStore, IntoResponseWithStatus, Arc, Send (+14 more)
...
## Knowledge Gaps
- **3355 isolated node(s):** `printWidth`, `tabWidth`, `useTabs`, `semi`, `singleQuote` (+3350 more)
...
- **Why does `StorageError` connect `StorageError` to `BudgetAlertRepo`, `.create_event`, `MemoryStore`, `.upsert_any_in`, `src/dashboard_admin_repo.rs`, `ToolMetadataStoreError`, `github_integration_repo.rs`, `BudgetAlertStoreError`, `Result`, `PostgresUserAdapter`, `RedteamPlanRepo`, `EnvironmentRepo`, `src/mcp_gateway_repo.rs`, `DashboardAdminStoreError`, `ToolMetadataRepo`, `UserRepo`, `.query`, `Result`, `McpGatewayStoreError`, `dashboard_admin_repo/api_keys.rs`, `Result`, `RedteamJobStoreError`, `GatewayStoreError`, `PostgresHumanReviewAdapter`, `tl-server/src/llm_pricing.rs`, `MemoryLlmUsageStore`, `PostgresFinancialAdapter`, `AuthorizationStoreError`, `postgres`, `view_from_record`, `PostgresAnalyticsAdapter`, `src/llm_usage_repo.rs`, `PostgresGitHubIntegrationAdapter`, `.facts`, `LlmPricingRepo`, `oauth_store.rs`, `postgres/tests.rs`, `PolicyRepo`, `RunStoreError`, `PostgresLabelPolicyAdapter`, `models.rs`, `.analytics`, `AgentRepo`, `RedteamReportShareRepo`, `PostgresEnvironmentAdapter`, `schema.rs`, `provider_record_to_wire`, `human_review_repo/validation.rs`, `share.rs`, `metrics.rs`, `EscalationRepo`, `assignment_views_for`, `.create_event`, `TeamStoreError`, `KnowledgeRepo`, `src/writer.rs`, `MemoryRedteamPlanStore`?**
...
- **Should `agno.py` be split into smaller, more focused modules?**
  _Cohesion score 0.04626931567328919 - nodes in this community are weakly interconnected._