...
## Corpus Check
- 205 files · ~80,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1704 nodes · 2682 edges · 122 communities (109 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 252 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3480d214`
...
Cohesion: 0.11
Nodes (32): Exception, ApiError, ApiErrorCode, Decode, Forbidden, from_response(), Gone, Internal (+24 more)
...
Cohesion: 0.11
Nodes (11): BuilderKey, BuilderValues, buildYaml(), INITIAL_BUILDER, LoadState, yamlString(), Badge(), BadgeProps (+3 more)
...
Cohesion: 0.13
Nodes (17): cn(), SeverityBadge(), DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle (+9 more)
...
Cohesion: 0.15
Nodes (8): Label, labelVariants, ScrollArea, ScrollBar, Separator, TabsContent, TabsList, TabsTrigger
...
Cohesion: 0.4
Nodes (5): test_status_to_code_table_matches_rust(), code_from_http_status(), Map a raw HTTP status to the canonical error code.      Used as a fallback when, Build an ApiError from a raw HTTP response when the body isn't ours., synthesize_api_error()
...
## Knowledge Gaps
- **468 isolated node(s):** `fetchSpy`, `client`, `cfg`, `c`, `d` (+463 more)
...
- **Why does `load_str()` connect `Community 1` to `Community 0`, `Community 3`, `Community 8`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `router()` connect `Community 2` to `Community 24`, `Community 22`?**
