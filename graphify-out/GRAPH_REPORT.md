...
## Corpus Check
- 187 files · ~70,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1487 nodes · 2252 edges · 121 communities (108 shown, 13 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20fa06bd`
...
Cohesion: 0.11
Nodes (36): router(), MemoryStore, memory_app_state(), build_app(), build_app_with_store(), delete_then_get_returns_404(), delete_unknown_yields_404(), json_with_empty_agent_id_yields_422() (+28 more)
...
Cohesion: 0.17
Nodes (10): cn(), Button, ButtonProps, buttonVariants, Input, Label, labelVariants, Separator (+2 more)
...
Cohesion: 0.26
Nodes (12): flush(), spawn_writer(), TraceWrite, verdict_text(), writer_loop(), WriterConfig, batch_size_triggers_flush(), caller_send_is_non_blocking_under_load() (+4 more)
...
Cohesion: 0.25
Nodes (13): BaseModel, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, CheckRequest, Decision (+5 more)
...
## Knowledge Gaps
- **424 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+419 more)
...
- **Why does `load_str()` connect `Community 2` to `Community 8`, `Community 0`, `Community 22`, `Community 15`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `write_canonical()` connect `Community 18` to `Community 3`?**
