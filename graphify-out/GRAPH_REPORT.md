...
## Corpus Check
- 204 files · ~79,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1692 nodes · 2654 edges · 126 communities (109 shown, 17 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `201bf8ec`
...
Cohesion: 0.11
Nodes (32): dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit, mock_embedder_round_trip_through_index(), orthogonal_vector_below_threshold(), ranks_by_similarity_descending() (+24 more)
...
Cohesion: 0.14
Nodes (25): Exception, ApiError, ApiErrorCode, Forbidden, Gone, Internal, Invalid, NotFound (+17 more)
...
Cohesion: 0.11
Nodes (18): cn(), SeverityBadge(), Button, ButtonProps, buttonVariants, DialogContent, DialogDescription, DialogFooter() (+10 more)
...
Cohesion: 0.11
Nodes (11): PolicyValidationResult, BuilderKey, BuilderValues, buildYaml(), INITIAL_BUILDER, LoadState, yamlString(), Input (+3 more)
...
Cohesion: 0.19
Nodes (15): is_yaml_content_type(), load_str_and_validate_endpoint_agree_on_valid_yaml(), malformed_yaml_returns_validation_issue(), MemoryPolicyRecord, parse_policy(), parse_policy_body(), ParsedPolicyBody, PolicyState (+7 more)

### Community 30 - "Community 30"
Cohesion: 0.17
Nodes (12): api_error_response(), api_error_response_with_details(), delete_policy(), get_policy(), list_policies(), MemoryPolicyStore, policy_document(), policy_store_error_response() (+4 more)
...
Cohesion: 0.23
Nodes (14): deletePolicy(), getClient(), getPolicy(), listPolicies(), ParsedPolicyDocument, ParsedPolicySummary, policyDocumentSchema, policyListResponseSchema (+6 more)
...
Cohesion: 0.26
Nodes (9): Channel, CheckRequest, Decision, branchFor(), dispatch(), guard(), GuardCallbacks, GuardLogEvent (+1 more)
...
Cohesion: 0.25
Nodes (3): migrate(), PostgresStore, verdict_text()
...
- **Why does `load_str()` connect `Community 2` to `Community 32`, `Community 1`, `Community 9`, `Community 18`, `Community 29`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 9` to `Community 32`, `Community 0`, `Community 2`, `Community 1`, `Community 7`, `Community 18`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `router()` connect `Community 0` to `Community 9`, `Community 25`?**
