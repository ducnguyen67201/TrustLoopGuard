...
## Corpus Check
- 176 files · ~63,733 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1302 nodes · 2002 edges · 104 communities (94 shown, 10 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 191 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfcb3565`
...
Cohesion: 0.05
Nodes (26): AgentRepo, AuthConfig, EnvError, from_env_rejects_missing(), require_bearer(), subtle_eq(), unauthorized(), EscalationRepo (+18 more)
...
## Knowledge Gaps
- **344 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+339 more)
...
- **Why does `main()` connect `Community 15` to `Community 0`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `router()` connect `Community 3` to `Community 20`, `Community 15`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 9` to `Community 8`, `Community 0`, `Community 4`, `Community 15`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
