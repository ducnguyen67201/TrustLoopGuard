...
## Corpus Check
- 140 files · ~52,435 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1083 nodes · 1648 edges · 91 communities (79 shown, 12 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 139 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2753e660`
...
Cohesion: 0.07
Nodes (20): AgentRepo, Client, parse_retry_after(), migrate(), PostgresStore, verdict_text(), build_from_config_validates_referenced_providers(), JudgeKind (+12 more)
...
Cohesion: 0.09
Nodes (22): allow_helper_sets_verdict(), ApiError, ApiErrorCode, Channel, CheckRequest, Decision, new_trace_id(), SdkError (+14 more)
...
Cohesion: 0.14
Nodes (25): Exception, ApiError, ApiErrorCode, Decode, Forbidden, Gone, Internal, Invalid (+17 more)
...
Cohesion: 0.13
Nodes (18): ApiDoc, AppState, check(), router(), MemoryStore, build_app(), build_app_with_store(), delete_then_get_returns_404() (+10 more)
...
Cohesion: 0.44
Nodes (10): build_app(), check_request(), correct_bearer_returns_200(), health_endpoint_works_with_random_token_too(), health_endpoint_works_without_token(), malformed_authorization_header_yields_401(), missing_bearer_returns_401_with_api_error_envelope(), no_auth_config_disables_middleware() (+2 more)
...
## Knowledge Gaps
- **260 isolated node(s):** `cfg`, `c`, `d`, `STATUS_TO_CODE`, `DEFAULT_RETRIABLE` (+255 more)
...
- **Why does `main()` connect `Community 13` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 14`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 7` to `Community 0`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `fake_decision()` connect `Community 6` to `Community 5`?**
