...
## Corpus Check
- 174 files · ~62,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1288 nodes · 1989 edges · 107 communities (94 shown, 13 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 191 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6cc1739b`
...
Cohesion: 0.17
Nodes (7): Client, ClientOptions, parseRetryAfter(), SdkError, Transport, DEFAULT_RETRY, nextDelay()
...
- **Why does `build_app_state()` connect `Community 19` to `Community 0`, `Community 29`, `Community 15`?**
