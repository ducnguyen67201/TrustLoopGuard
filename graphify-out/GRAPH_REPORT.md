...
## Corpus Check
- 128 files · ~46,640 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 962 nodes · 1452 edges · 79 communities (69 shown, 10 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f11bf89f`
...
1. `SdkError` - 21 edges
2. `Client` - 16 edges
3. `AsyncClient` - 16 edges
4. `run()` - 15 edges
5. `v0 Design Decisions` - 15 edges
6. `ApiErrorCode` - 14 edges
7. `ApiError` - 14 edges
8. `main()` - 13 edges
9. `Crates` - 13 edges
...
- `Client` --uses--> `Decision`  [INFERRED]
  sdks/python/src/trustloopguard/client.py → sdks/python/src/trustloopguard/_generated/types.py
- `Client` --uses--> `Decode`  [INFERRED]
  sdks/python/src/trustloopguard/client.py → sdks/python/src/trustloopguard/errors.py
- `Client` --uses--> `SdkError`  [INFERRED]
  sdks/python/src/trustloopguard/client.py → sdks/python/src/trustloopguard/errors.py
- `Client` --uses--> `Transport`  [INFERRED]
  sdks/python/src/trustloopguard/client.py → sdks/python/src/trustloopguard/errors.py
...
Cohesion: 0.05
Nodes (38): load_agent_str(), loads_committed_fixture_acme_support_v3(), parses_full_featured_profile(), parses_minimal_profile(), rejects_malformed_yaml(), rejects_missing_agent_id(), rejects_missing_in_scope(), validate() (+30 more)
...
## Knowledge Gaps
- **233 isolated node(s):** `cfg`, `c`, `d`, `STATUS_TO_CODE`, `DEFAULT_RETRIABLE` (+228 more)
...
- **Why does `main()` connect `Community 0` to `Community 2`, `Community 4`, `Community 6`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 6` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `fake_decision()` connect `Community 5` to `Community 11`?**
...
- **What connects `cfg`, `c`, `d` to the rest of the system?**
