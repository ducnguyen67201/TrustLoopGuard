...
## Corpus Check
- 199 files · ~75,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1609 nodes · 2478 edges · 118 communities (106 shown, 12 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 239 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `867cab07`
...
Cohesion: 0.05
Nodes (30): AgentRepo, EscalationRepo, EscalationRow, dim_mismatch_yields_empty_query(), empty_index_returns_empty_query(), HnswIndex, identical_vector_scores_one(), IndexHit (+22 more)
...
Cohesion: 0.07
Nodes (33): bench_check_async_50_policies_4kb(), bench_check_async_cache_hit(), bench_check_async_empty_default(), bench_check_sync_empty(), bench_universal_only_4kb(), fifty_policies(), large_req(), small_req() (+25 more)
...
Cohesion: 0.1
Nodes (47): ApiDoc, AppState, check(), router(), PolicyValidationIssue, memory_app_state(), build_app(), build_app_with_store() (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (24): ApiErrorCode, buffer_truncates_to_window(), Client, parse_retry_after(), SdkError, StreamDecision, StreamingChecker, synthesize_400_is_not_retriable() (+16 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (35): Enum, Exception, ApiError, ApiErrorCode, Channel, Severity, Verdict, Decode (+27 more)
...
Cohesion: 0.2
Nodes (17): BaseModel, AgentAuthority, AgentListResponse, AgentProfile, AgentScope, AgentTone, CheckRequest, Decision (+9 more)
...
Cohesion: 0.17
Nodes (10): cn(), Input, ScrollArea, ScrollBar, Separator, Skeleton(), TabsContent, TabsList (+2 more)
...
## Knowledge Gaps
- **462 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+457 more)
...
- **Why does `main()` connect `Community 19` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 10`, `Community 20`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 1` to `Community 0`, `Community 2`, `Community 9`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `router()` connect `Community 4` to `Community 24`, `Community 0`, `Community 19`?**
