...
## Corpus Check
- 190 files · ~70,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1496 nodes · 2260 edges · 116 communities (101 shown, 15 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ef4823a`
...
Cohesion: 0.05
Nodes (30): AgentRepo, EscalationRepo, EscalationRow, migrate(), PostgresStore, verdict_text(), build_from_config_validates_referenced_providers(), JudgeKind (+22 more)
...
## Knowledge Gaps
- **427 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+422 more)
...
- **Why does `main()` connect `Community 18` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 7`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 1` to `Community 0`, `Community 2`, `Community 18`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `build_app_state()` connect `Community 0` to `Community 18`, `Community 2`?**
