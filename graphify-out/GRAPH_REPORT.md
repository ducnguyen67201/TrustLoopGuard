...
## Corpus Check
- 138 files · ~49,934 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1036 nodes · 1545 edges · 88 communities (78 shown, 10 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 132 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eee17475`
...
Cohesion: 0.06
Nodes (28): ApiError, ApiErrorCode, Channel, CheckRequest, Client, ClientOptions, CODE_TO_CLASS, codeFromHttpStatus() (+20 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (23): Client, parse_retry_after(), SdkError, synthesize_400_is_not_retriable(), synthesize_api_error(), synthesize_unknown_body_uses_status_fallback(), migrate(), PostgresStore (+15 more)
...
## Knowledge Gaps
- **256 isolated node(s):** `cfg`, `c`, `d`, `STATUS_TO_CODE`, `DEFAULT_RETRIABLE` (+251 more)
...
- **Why does `main()` connect `Community 12` to `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 16`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 6` to `Community 1`, `Community 2`, `Community 12`?**
