...
## Corpus Check
- 186 files · ~68,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1450 nodes · 2216 edges · 114 communities (102 shown, 12 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2c9ce331`
...
6. `Client` - 17 edges
7. `run()` - 15 edges
8. `v0 Design Decisions` - 15 edges
9. `ApiErrorCode` - 14 edges
...
Cohesion: 0.05
Nodes (27): AgentRepo, AuthConfig, EnvError, from_env_rejects_missing(), require_bearer(), subtle_eq(), unauthorized(), EscalationRepo (+19 more)
...
Cohesion: 0.1
Nodes (33): Enum, Exception, ApiError, ApiErrorCode, Channel, Severity, Verdict, Decode (+25 more)
...
## Knowledge Gaps
- **399 isolated node(s):** `cfg`, `c`, `d`, `DEFAULT_OPTS`, `client` (+394 more)
...
- **Why does `main()` connect `Community 18` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `load_str()` connect `Community 4` to `Community 0`, `Community 5`, `Community 10`, `Community 17`, `Community 18`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `write_canonical()` connect `Community 19` to `Community 2`?**
