...
## Corpus Check
- 1719 files · ~1,071,197 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17855 nodes · 38291 edges · 1944 communities (1290 shown, 654 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1837 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ed2369c`
...
## Communities (1944 total, 654 thin omitted)

### Community 1 - "agno.py"
Cohesion: 0.04
Nodes (120): BaseEvent, BaseMiddleware, Context, ModelResponse, OnAllowAsync, OnBlockAsync, OnDeferAsync, OnErrorAsync (+112 more)
...
Cohesion: 0.03
Nodes (70): DELETE(), PATCH(), POST(), RouteContext, GET(), RouteContext, GET(), POST() (+62 more)
...
### Community 58 - "tlClientForRequest"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (30): POST(), RouteContext, GET(), GET(), POST(), GET(), POST(), bodySchema (+22 more)
...
Cohesion: 0.05
Nodes (74): Exception, RateLimited, code_from_http_status(), Decode, Forbidden, from_response(), Gone, Internal (+66 more)
...
### Community 116 - "EnvironmentStore"
Cohesion: 0.12
Nodes (37): ApiKeyBatchRevokeRequest, DashboardAdminState, batch_revoke_api_keys(), create_api_key(), generate_plaintext_key(), get_environment_checker_modes(), get_settings(), list_api_keys() (+29 more)
...
Cohesion: 0.11
Nodes (24): AuthScreen(), OrDivider(), CredentialsForm(), OAuthButtons(), safeRedirect(), SignInPage(), safeRedirect(), SignUpPage() (+16 more)

### Community 120 - "MarketingLocale"
Cohesion: 0.06
Nodes (35): metadata, CodeBlock(), CodeBlockProps, highlight(), KEYWORDS, LABELS, Lang, tokenize() (+27 more)
...
Cohesion: 0.06
Nodes (58): ContextualDemoHandlersDependencies, approvalReply(), boundedHistoryItems(), boundedProfileContext(), buildContextualModelInput(), cap(), ContextualAgentClient, ContextualAgentDependencies (+50 more)
...
Cohesion: 0.12
Nodes (27): auth_kind_text(), CatalogToolInput, CredentialPatch, EntitledMcpTool, McpConnectionPatch, McpConnectionSecret, McpGatewayRepo, NewMcpConnection (+19 more)
...
Cohesion: 0.06
Nodes (57): AgentStore, Send, Sync, AnalyticsStore, Send, Sync, BudgetAlertStore, Send (+49 more)
...
Cohesion: 0.05
Nodes (51): clientAddress(), createHealthcareDemoHandlers(), handlers, HealthcareDemoHandlersDependencies, isRateLimited(), pruneExpiredHits(), handlers(), inventoryPayload() (+43 more)
...
Cohesion: 0.06
Nodes (46): FinancialStoreError, clean_operation(), clean_required(), is_valid_execution_transition(), CreateFinancialActionRequest, FinancialExecutionStatus, Result, String (+38 more)
...
### Community 232 - "entitled_from_records"
Cohesion: 0.23
Nodes (11): entitled_from_records(), McpGatewayRepo, CatalogToolInput, EntitledMcpTool, McpGatewayConnection, McpGatewayTool, Option, Result (+3 more)
...
Cohesion: 0.12
Nodes (26): default_retry_policy_is_five_attempts(), deliver_one(), delivery_loop(), EscalationConfig, EscalationPayload, persist_pending(), RetryPolicy, Arc (+18 more)
...
Cohesion: 0.06
Nodes (44): clientAddress(), handlers, isRateLimited(), pruneExpiredHits(), resolveProfile(), RouteContext, CheckStep(), CompanyBrandStyle (+36 more)
...
Cohesion: 0.11
Nodes (31): MatchClause, Matcher, Channel, Matcher, String, Vec, WhenClause, accepts_canonical_scope_fields() (+23 more)
...
Cohesion: 0.07
Nodes (33): Duration, GatewayProviderConnectionSecret, GatewayRepo, GatewayRoutePatch, ResolvedGatewayRoute, DbConnection, DbPool, GatewayProviderConnection (+25 more)
...
### Community 319 - "guard"
Cohesion: 0.08
Nodes (66): GuardModeInput, OnAllowSync, OnBlockSync, OnDeferSync, OnErrorSync, OnRequireApprovalSync, OnReviseSync, _collect_chunks() (+58 more)
...
Cohesion: 0.09
Nodes (28): COPY, DemoMeetingPrompt(), DemoMeetingPromptAction, DemoMeetingPromptState, initialDemoMeetingPromptState, reduceDemoMeetingPromptState(), useDemoMeetingPrompt(), metadata (+20 more)
...
### Community 334 - "MemoryToolMetadataStore"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (25): HandlerCtx, Default, Self, aggregate(), DefaultTierRunner, Arc, CancellationToken, Decision (+17 more)
...
Cohesion: 0.14
Nodes (33): claudeAdapter, EVENTS, codexAdapter, COVERAGE_EXCEPTIONS, EVENTS, quotePosix(), quoteWindows(), directories (+25 more)
...
### Community 396 - "authorize_workspace_admin"
Cohesion: 0.30
...
Cohesion: 0.12
Nodes (35): ADAPTERS, checkHealth(), commandPaths(), copyRuntime(), FileSnapshot, filesTouchedByInstall(), hostConfigFile(), hostContext() (+27 more)

### Community 418 - "LlmUsageStoreError"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (55): boundedHistoryItems(), buildHealthcareModelInput(), cap(), decisionCheck(), generateHealthcareDraft, GuardHealthcareDraft, GuardHealthcareDraftRequest, GuardHealthcareDraftResult (+47 more)
...
### Community 486 - "$defs"
Cohesion: 0.06
Nodes (39): description, required, type, enum, type, $defs, CheckerFindingEvidence, Confidentiality (+31 more)

### Community 487 - "connection_record_to_wire"
Cohesion: 0.25
Nodes (11): connection_record_to_wire(), McpGatewayRepo, AsyncPgConnection, McpConnectionPatch, McpConnectionSecret, McpGatewayConnection, NewMcpConnection, Result (+3 more)
...
### Community 548 - "run"
Cohesion: 0.19
Nodes (14): block_signal_from_hit(), cancelled(), CancellationToken, Option, run(), bulleted(), extract_docs(), AgentProfile (+6 more)
...
Cohesion: 0.07
Nodes (53): agentic_payment_counterparty(), agentic_payment_metadata(), agentic_payment_principal(), authorization_error(), decision_from_action(), enforcing_effect(), ensure_agentic_payment_principal(), evidence_bool() (+45 more)
...
### Community 669 - "AuthorizationCoordinator"
Cohesion: 0.16
...
### Community 1653 - "procurement-page.tsx"
Cohesion: 0.17
...
Cohesion: 0.10
Nodes (32): build_policy_draft_llm(), router(), Arc, Option, memory_app_state(), analytics_catalog_query_and_saved_views_round_trip(), analytics_endpoints_are_protected_by_bearer_auth(), internal_bearer_analytics_authorizes_members_and_platform_admins() (+24 more)
...
### Community 1849 - "hero.tsx"
Cohesion: 0.16
Nodes (8): COPY, Hero(), COPY, QuickInstall(), env, gtmId, postHogProjectToken, publicUrl
...
### Community 1853 - "RunStoreError"
Cohesion: 0.17
Nodes (17): CreateRunRequest, UpdateRunRequest, RunStoreError, clean_optional(), normalize_metadata(), CreateRunEventRequest, CreateRunRequest, Option (+9 more)
...
### Community 1872 - "LlmUsageEvent.ts"
Cohesion: 0.20
...
### Community 1881 - "insert_existing_workspace_member"
Cohesion: 0.10
...
### Community 1886 - "spawn_escalation_worker"
Cohesion: 0.44
Nodes (11): spawn_escalation_worker(), config(), deferred_decision_triggers_post_within_100ms(), deliveries_are_concurrent_not_serial(), drop_sender_completes_worker_handle(), event_handler_fires_escalation_on_defer_effect(), exhausted_retries_stop_after_max_attempts(), fast_retry() (+3 more)
...
### Community 1890 - "github_integration/validation.rs"
Cohesion: 0.27
...
### Community 1914 - "check_gateway_content"
Cohesion: 0.33
...
### Community 1915 - "parse_provider_request"
Cohesion: 0.36
Nodes (7): parse_provider_request(), prepare_streaming_request(), Bytes, P, Response, Result, Value

### Community 1916 - "RunListFilter"
Cohesion: 0.29
Nodes (7): Arc, Option, RunKind, RunStatus, String, RunListFilter, RunState

### Community 1917 - ".policy_boundary"
Cohesion: 0.33
Nodes (5): AdapterPolicyBoundary, Arc, AuthorityRequirement, AuthorizationFinding, Vec

### Community 1918 - "ParamRole"
Cohesion: 0.40
...
### Community 1921 - "trivial_schema"
Cohesion: 0.83
Nodes (3): openai_round_trip(), openrouter_round_trip(), trivial_schema()

### Community 1922 - "latest_event_evidence"
Cohesion: 0.50
...
- **Why does `StorageError` connect `StorageError` to `BudgetAlertRepo`, `MemoryStore`, `src/oauth.rs`, `src/dashboard_admin_repo.rs`, `github_integration_repo.rs`, `Result`, `UserRepo`, `RedteamPlanRepo`, `MemoryRedteamPlanStore`, `EnvironmentRepo`, `src/mcp_gateway_repo.rs`, `ToolMetadataRepo`, `postgres`, `LlmUsageStoreError`, `PostgresMcpGatewayAdapter`, `dashboard_admin_repo/api_keys.rs`, `Result`, `RedteamJobStoreError`, `GatewayStoreError`, `PostgresHumanReviewAdapter`, `tl-server/src/llm_pricing.rs`, `Result`, `FinancialStoreError`, `AuthorizationStoreError`, `postgres/tests.rs`, `PostgresAnalyticsAdapter`, `latest_review_outcomes`, `src/llm_usage_repo.rs`, `GitHubIntegrationStoreError`, `UserStoreError`, `RunStoreError`, `LlmPricingRepo`, `OAuthRepo`, `EnvironmentStoreError`, `PostgresAgentAdapter`, `DashboardAdminStoreError`, `PolicyRepo`, `PostgresRunAdapter`, `PostgresLabelPolicyAdapter`, `human_review_repo/validation.rs`, `Validation`, `MemoryToolMetadataStore`, `.query`, `.analytics`, `AgentRepo`, `BudgetAlertStoreError`, `redteam_job_repo.rs`, `insert_existing_workspace_member`, `provider_record_to_wire`, `schema.rs`, `share.rs`, `metrics.rs`, `connection_record_to_wire`, `entitled_from_records`, `EscalationRepo`, `EntityVersionRecord`, `assignment_views_for`, `.create_event`, `TeamStoreError`, `view_from_record`, `.facts`, `KnowledgeRepo`, `src/writer.rs`, `latest_review_outcomes`?**
