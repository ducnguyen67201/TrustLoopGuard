  ...
  navMain: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: '/grants',
          icon: IconKey,
          description: 'Reusable authority bounded by current policies',
        },
        {
          title: 'Financial',
          url: '/financial',
          icon: IconCreditCard,
          description: 'Money-moving actions, execution outcomes, ledger, and receipts',
        },
        {
          title: 'Analytics',
          url: '/analytics',
      ...
      items: [
        {
          ...
          url: '/policies',
          icon: IconShieldCheck,
          description: 'Rules that permit, deny, transform, require approval, or defer',
        },
        {
          title: 'Agents',
          url: '/agents',
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild className="data-[slot=sidebar-menu-button]:p-1.5!">
              <Link href={withContext('/')}>
                ...
                <span className="font-mono text-base font-normal tracking-wide">
                  Featherlane AI
                </span>
              </Link>
            </SidebarMenuButton>
