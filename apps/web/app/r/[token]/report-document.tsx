...
export function ReportDocument({ payload }: { payload: RedteamReportPayload }): JSX.Element {
  ...
  return (
    <Document
      title={`Featherlane AI Vulnerability Report — ${job.target}`}
      author="Featherlane AI"
    >
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.brandRow}>
          <View style={styles.brandLeft}>
            ...
            <Text style={styles.wordmark}>Featherlane AI</Text>
          </View>
        ...
        {/* How Featherlane AI helps */}
        <View style={styles.helpBox}>
          <Text style={styles.helpTitle}>How Featherlane AI closes these gaps</Text>
          <Text style={styles.helpText}>
            Each landed attack is a real-time guardrail Featherlane AI can enforce before a response
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>
            Generated by Featherlane AI · {formatDate(payload.generated_at)}
          </Text>
          <Text
