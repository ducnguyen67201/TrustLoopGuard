...
const DECISIONS: Decision[] = [
  { time: '14:32:07', merchant: 'Northwind Supplies', amount: '$4,820.00', verdict: 'block', chip: 'BLOCK', trace: 'tr_9f3a71' },
  { time: '14:31:58', merchant: 'Stripe payout · ops', amount: '$1,200.00', verdict: 'allow', chip: 'ALLOW', trace: 'tr_a14c08' },
  { time: '14:31:12', merchant: 'AWS invoice (capped from $6,400)', amount: '$5,000.00', verdict: 'rewrite', chip: 'CAP', trace: 'tr_c4e0b2' },
  { time: '14:30:41', merchant: 'Refund · order #8842', amount: '$640.00', verdict: 'escalate', chip: 'HOLD', trace: 'tr_7c4e19' },
  { time: '14:29:55', merchant: 'Acme travel booking', amount: '$312.40', verdict: 'allow', chip: 'ALLOW', trace: 'tr_2b8840' },
  { time: '14:28:33', merchant: 'Vendor wire · net-30', amount: '$9,300.00', verdict: 'escalate', chip: 'HOLD', trace: 'tr_5f7a02' },
  { time: '14:27:50', merchant: 'OpenAI API · usage', amount: '$84.20', verdict: 'allow', chip: 'ALLOW', trace: 'tr_1d9c33' },
  { time: '14:26:14', merchant: 'Unknown payee · ACH', amount: '$2,500.00', verdict: 'block', chip: 'BLOCK', trace: 'tr_b07e55' },
];
  ...
  return (
    <section id="monitoring" aria-labelledby="monitoring-heading" className="monitoring-band">
      <div className="monitoring-inner">
        ...
        <div className="monitoring-visual" aria-label="Live decisions feed of recent agent money actions">
          <div className="monitoring-chrome">
            <span className="dot" style={{ background: 'var(--color-block)' }} aria-hidden="true" />
            <span className="dot" style={{ background: 'var(--color-rewrite)' }} aria-hidden="true" />
