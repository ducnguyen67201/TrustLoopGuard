...
export const REFUND_PAGE_COPY: Record<MarketingLocale, RefundPageCopy> = {
  en: {
    ...
    introduction:
      'Pick an amount below. TrustLoopGuard allows, holds, or blocks the agent before Stripe — real APIs, not a scripted animation.',
  ...
  vi: {
    ...
    description:
      'Yêu cầu tác nhân hỗ trợ AI hoàn tiền và xem TrustLoopGuard cho phép, giữ để phê duyệt hoặc chặn hành động Stripe trước khi thực thi.',
    homeLabel: 'Trang chủ TrustLoopGuard',
    stripeTestMode: 'Stripe thử nghiệm',
    viewSource: 'Xem mã nguồn',
    eyebrow: 'Demo hoàn tiền trực tiếp',
    heading: 'Yêu cầu tác nhân. Xem TrustLoopGuard quyết định.',
    introduction:
      'Chọn một số tiền bên dưới. TrustLoopGuard cho phép, giữ để phê duyệt hoặc chặn tác nhân trước khi gọi Stripe — API thật, không phải hoạt ảnh dựng sẵn.',
...
export const REFUND_UI_COPY: Record<MarketingLocale, RefundUiCopy> = {
  en: {
    ...
    greetingAfterOrder:
      'and propose a refund. Every refund must pass TrustLoopGuard before Stripe can execute it.',
    customer: 'Customer',
    agentWorking: 'OpenAI is choosing and calling the refund tools…',
    approvalRequired: 'Human approval required',
    approvalDescription:
      'Open the exact held action in TrustLoopGuard. This demo updates automatically.',
    ...
    stripeTestMode: 'Stripe test mode',
    stripeExecuted: 'Created the refund after TrustLoopGuard authorization.',
    stripeHeld: 'Not called. The refund is waiting for human approval.',
    stripeBlocked: 'Not called. TrustLoopGuard blocked the proposed refund.',
    stripeDefault: 'Creates the refund only after TrustLoopGuard authorization.',
  ...
  vi: {
    ...
    greetingAfterOrder:
      'và đề xuất hoàn tiền. Mọi khoản hoàn tiền phải qua TrustLoopGuard trước khi Stripe có thể thực thi.',
    customer: 'Khách hàng',
    agentWorking: 'OpenAI đang chọn và gọi các công cụ hoàn tiền…',
    approvalRequired: 'Cần con người phê duyệt',
    approvalDescription:
      'Mở đúng hành động đang được giữ trong TrustLoopGuard. Demo này sẽ tự động cập nhật.',
    ...
    stripeTestMode: 'Stripe thử nghiệm',
    stripeExecuted: 'Đã tạo khoản hoàn tiền sau khi TrustLoopGuard cho phép.',
    stripeHeld: 'Chưa gọi Stripe. Khoản hoàn tiền đang chờ con người phê duyệt.',
    stripeBlocked: 'Chưa gọi Stripe. TrustLoopGuard đã chặn khoản hoàn tiền được đề xuất.',
    stripeDefault: 'Chỉ tạo khoản hoàn tiền sau khi TrustLoopGuard cho phép.',
