...
export const CONTEXTUAL_PAGE_COPY: Record<HealthcareDemoLocale, ContextualPageCopy> = {
  en: {
    ...
    description: (companyName) =>
      `A private, public-source TrustLoopGuard concept for ${companyName}.`,
    fallbackDescription: 'A private TrustLoopGuard concept demo.',
  ...
  vi: {
    ...
    description: (companyName) =>
      `Bản thử nghiệm TrustLoopGuard riêng cho ${companyName}, được xây dựng từ nguồn công khai.`,
    fallbackDescription: 'Bản thử nghiệm TrustLoopGuard được cá nhân hóa.',
    disclaimer: (companyName) =>
...
export const CONTEXTUAL_UI_COPY: Record<HealthcareDemoLocale, ContextualUiCopy> = {
  en: {
    ...
    monitorTitle: 'TrustLoopGuard policy monitor',
    ...
    progressInput: 'TrustLoopGuard is checking the visitor message…',
    progressModel: 'OpenAI is drafting with bounded workflow context…',
    progressOutput: 'TrustLoopGuard is checking the drafted reply…',
  ...
  vi: {
    ...
    monitorTitle: 'Trình giám sát chính sách TrustLoopGuard',
    ...
    progressInput: 'TrustLoopGuard đang kiểm tra tin nhắn của khách…',
