---
title: Architecture
description: How TrustLoopGuard's pieces fit together, how a request flows, and where the latency goes.
---
...
The crate boundaries (see [Crates](/docs/concepts/crates)) exist precisely so these additions are mechanical.
