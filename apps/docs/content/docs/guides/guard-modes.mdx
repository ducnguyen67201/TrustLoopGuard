...
Create one guardrail when your agent starts, then call it before each reply is
sent or spoken.
...
window and interrupts the moment an evaluator returns a non-`allow` verdict.
