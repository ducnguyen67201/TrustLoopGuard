 ...
 */
export type CheckerFindingEvidence = { rule: string, reason: string, recommended_verdict?: Verdict, source_chain?: Array<string>, risk_source?: string, failure_mode?: string, harm_class?: string, };
