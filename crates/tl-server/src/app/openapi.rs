...
use crate::{
    ...
    bench, dashboard_admin, environments, gateway, human_review, knowledge_sources, label_policy,
...
#[openapi(
    ...
    components(schemas(
        ...
        tl_core::RedteamJobResultListResponse,
        ...
        tl_core::BenchArm,
        tl_core::BenchRunStatus,
        tl_core::BenchRunCreateRequest,
        tl_core::BenchRunSummary,
        tl_core::BenchRunArmSummary,
        tl_core::BenchRunDetail,
        tl_core::BenchRunListResponse,
        tl_core::BenchArmMetrics,
        tl_core::BenchTrackMetrics,
        tl_core::BenchReportDelta,
        tl_core::BenchComparedCase,
        tl_core::BenchReportPayload,
    ...
    tags(
        ...
        (name = "bench", description = "Raw-vs-guarded benchmark runs and reports"),
