...
use crate::{
    ...
    budget_alerts, dashboard_admin, environments, financial, gateway, github_integration,
    human_review, knowledge_sources, label_policy, llm_pricing, llm_usage, policies, redteam, runs,
    team, tool_metadata, traces,
};
...
#[openapi(
    ...
    paths(
        ...
        financial::list_approval_requests,
        financial::create_mandate,
        financial::list_mandates,
        financial::revoke_mandate,
        financial::get_receipt,
        financial::get_decision_receipt,
        financial::record_action_outcome,
        financial::list_action_outcomes,
        financial::get_action,
        financial::approve_action,
        financial::get_approval_envelope,
        financial::approve_matching_actions,
    ...
    components(schemas(
        ...
        tl_core::AgenticPaymentDecision,
        ...
        tl_core::MandateRef,
        tl_core::FinancialMandateStatus,
        tl_core::AgenticPaymentMandateScope,
        tl_core::CreateFinancialMandateRequest,
        tl_core::FinancialMandate,
        tl_core::FinancialMandateListResponse,
        tl_core::FinancialReceipt,
        tl_core::EvidenceRef,
        tl_core::FinancialAction,
        tl_core::CreateFinancialActionRequest,
        tl_core::FinancialActionRecord,
        tl_core::FinancialApprovalEnvelope,
        tl_core::ApproveMatchingFinancialActionsRequest,
        tl_core::ApproveMatchingFinancialActionsResponse,
        ...
        tl_core::FinancialActionDecision,
        tl_core::FinancialDecisionRiskCode,
        tl_core::FinancialDecisionRisk,
        tl_core::FinancialAuthorizationScopeProof,
        tl_core::FinancialEvidenceProof,
        tl_core::FinancialExecutionProofStatus,
        tl_core::FinancialExecutionProof,
        tl_core::FinancialActionDecisionReceipt,
