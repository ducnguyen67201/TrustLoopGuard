...
The dashboard's `/api/workspace-policies` proxy also requires the selected membership to be Owner or
Admin and forwards that signed-in identity; the Rust endpoint repeats the role check.
